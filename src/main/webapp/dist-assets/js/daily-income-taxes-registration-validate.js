...
$(function() {
	...
	var errorTaxAmountHei = $("#errorTaxAmountHei");	
	

	// Buttons
	var buttonTaxDailySaveDailyIncomeTaxDetails = $("#buttonTaxDailySaveDailyIncomeTaxDetails");
	...
	AtaxRate.focusout(() => {
		AtaxRateReturn = checkOptionalNumber(AtaxRate, errorTaxRate); 
	});
	...
	taxAmountHei.focusout(() => {
		taxAmountHeiReturn = checkMandatoryNumber(taxAmountHei, errorTaxAmountHei);
	});
	
	

	buttonTaxDailySaveDailyIncomeTaxDetails.click(function() {
