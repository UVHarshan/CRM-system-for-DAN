...
<title id="pageTitleInvoiceCreate">Invoice Create</title>
<link
												...
												<div id="resumeInformation" class="collapse show"
                                                    ...
                                                    <!--    <div class="row">
                                                            <div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="date" id="targetPeriodStart" class="form-control" readonly="readonly">
																</div>
                                                            ...
                                                            <div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="date" id="targetPeriodEnd" class="form-control" readonly="readonly">
																</div>
																	...
																	<table
																		...
																		<tbody id="InvoiceDetailsTaxableTbodyId">
																			<tr id="InvoiceDetailsTaxableTrId">
																				...
																				<td>
																					<button id="calculation1" name="calculation"
													...
													<div
															...
															<button class="btn btn-info"
																id="buttonSaveInvoiceDetails">Save Invoice</button>
														</div>
													</div>
												</div>
											</div>
