...
<body class="text-left" >
 <%@ include file="./common/CacheControl.jsp"%>
                       ...
                       <!--        <div class="row  pt-3  ml-2 mr-2">
                              ...
                              <div class="row  pt-3  ml-2 mr-2">
                               ...
                               <div class="col-md-8 pt-0 pr-4">
                                 ...
                                 <input type="hidden" id="scheduledWorkingHoursHidden" />
                               </div>
                              </div>
                            <!--   <div class="row  pt-3  ml-2 mr-2">
                               <div class="col-md-4 pt-0 pr-4" >
                               ...
                               <div class="col-md-8 pt-0 pr-4">
                                 <input type="text" id="StartTime" name="StartTime" maxlength="5" class="form-control" style="min-width: 10px"/>
                               ...
                               <div class="col-md-8 pt-0 pr-4">
                                 <input type="text" id="EndingTime" name="EndingTime"  maxlength="5"  class="form-control" style="min-width: 10px"/>
                                 ...
                                 <table class="display table  table-bordered mb-0" id="advancepayment_table" style="width:100%">
                                   ...
                                   <tbody id="advancepaymentTbodyId">
                                    <tr>
                                       ...
                                       <td id="tableTHNominal" class="pl-2" style="width:60%;text-align: left;" ><input type="text" id="inputRowTransportationexpenses" name="advancePaymentNominal[]" class="form-control" disabled="disabled" value="Transportation Expenses"></td>
                                       <td colspan="2"class="pl-2" id="tableTHAmountOfMoney" style="text-align: left">
                                       <input type="text" id="advancePaymentAmountOfMoney"  name="advancePaymentAmountOfMoney[]" onfocusout="calculateSum(this)"  class="form-control"> 
                                       </td>                                                           
                                    </tr> 
                                    <tr>
                                       <td colspan="4"class="pl-2" id="tableTHAmountOfMoney" style="text-align: left">
                                       <input type="text" id="advancePaymentDetail" name="advancePaymentDetail[]"  class="form-control">
                                     ...
                                     <tr>
                                       ...
                                       <td id="tableTHNominal" class="pl-2" style="width:60%;text-align: left;" ><input type="text" id="rowPurchaseMoney" name="advancePaymentNominal[]" class="form-control" disabled="disabled" value="Purchase Money"></td>
                                       <td colspan="2"class="pl-2" id="tableTHAmountOfMoney" style="text-align: left">
                                       <input type="text" id="advancePaymentAmountOfMoney" name="advancePaymentAmountOfMoney[]" onfocusout="calculateSum(this)" class="form-control">
                                        </td>                                                           
                                    </tr> 
                                    <tr>
                                     ...
                                     <tr>
                                       ...
                                       <td id="tableTHNominal" class="pl-2" style="width:60%;text-align: left;" ><input type="text" id="rowExpenses" name="advancePaymentNominal[]" class="form-control" disabled="disabled" value="Expenses"></td>
                                       <td colspan="2" class="pl-2" id="tableTHAmountOfMoney" style="text-align: left">
                                       <input type="text" id="advancePaymentAmountOfMoney" name="advancePaymentAmountOfMoney[]" onfocusout="calculateSum(this)"  class="form-control">
                                        </td>                                                           
                                    </tr> 
                                   ...
                                   <tr>
                                       ...
                                       <input type="text" id="rowAccommodationFee" name="advancePaymentNominal[]" class="form-control" disabled="disabled" value="Accommodation fee">
                                       </td>
                                       <td colspan="2"class="pl-2" id="tableTHAmountOfMoney" style="text-align: left">
                                       <input type="text" id="advancePaymentAmountOfMoney" name="advancePaymentAmountOfMoney[]" onfocusout="calculateSum(this)"  class="form-control"> 
                                       </td>                                                           
    ...
    <script>
     ...
     function addAdvancePaymentRow()
     {
    	 ...
    	 let rowStr = '<tr>'+
			            ...
			            '<td colspan="2"class="pl-2" id="tableTHAmountOfMoney" style="text-align: left"><input type="text" id="advancePaymentAmountOfMoney" name="advancePaymentAmountOfMoney[]" onfocusout="calculateSum(this)" class="form-control"> </td>'+                                                           
			         '</tr>'+
			         '<tr>'+
			           '<td colspan="4"class="pl-2" id="tableTHAmountOfMoney" style="text-align: left"><input type="text" id="advancePaymentDetail" name="advancePaymentDetail[]"   class="form-control"></td>'+                                                           
			         '</tr>';
     ...
     function setLanguageWithTables(selectedLanguage) {
			loadSelectedLanguage(selectedLanguage,"item-list");
    ...
    function viewimplementDetail(result)
    {
    	 ...
    	 document.getElementById("scheduledWorkingHoursHidden").value  = result.data[0].scheduledWorkingHours != '' ? result.data[0].scheduledWorkingHours : "00:00";
    	 ...
    	 document.getElementById("BreakTime").value  = result.data[0].actualBreakTime;
    	 ...
    	 {
    		 document.getElementById("buttonExpenseReport").disabled = true;   
    	 }
         ...
         for(i=0;i<result.data[0].advancePayments.length;i++)
         {
	    	 ...
	    	 let rowStr = '<tr>'+
				            ...
				            '<td colspan="2"class="pl-2" id="tableTHAmountOfMoney" style="text-align: left">'+
				            '<input type="text"  value="'+advancePaymentItemAmount+'"  id="advancePaymentAmountOfMoney" name="advancePaymentAmountOfMoney[]" onfocusout="calculateSum(this)"  class="form-control"> </td>'+                                                           
				          '</tr> '+
				          '<tr>'+
				           '<td colspan="4"class="pl-2" id="tableTHAmountOfMoney" style="text-align: left">'+
				           '<input type="text" value="'+advancePaymentItemDetail+'" id="advancePaymentDetail" name="advancePaymentDetail[]"   class="form-control"></td>'+                                                           
				          '</tr>';
	    	          $("#advancepaymentTbodyId").append(rowStr);
         }
        ...
        // calculateWorkingHoursAndOvertimeHours();  
    }
    ...
    function calculateWorkingHoursAndOvertimeHours()
    {
    	let start = document.getElementById("StartTime").value;
    	let end   = document.getElementById("EndingTime").value;
    	let breakTime = document.getElementById("BreakTime").value;
    	let scheduledWorkingHours = document.getElementById("scheduledWorkingHoursHidden").value;
    	let actualWorkHours = document.getElementById("spanActualWorkingHoursValue").innerHTML = calActualWorkingHours(start,end,breakTime);
    	let OvertimeHours = document.getElementById("OvertimeHours").value = calActualWorkingHours("00:00",actualWorkHours,scheduledWorkingHours);
    ...
    function calculateSum(nodeObj)
    {
    	...
    	{	
    		if(!isNaN(PaymentAmountOfMoneyArray[i].value)) {
