                        ...
                        <div id="bodyMainCard" class="card mb-4">
                            <div class="card-body p-0"  >
                              ...
                              <div class="row pt-4 pb-2 mt-2 ml-2">
                                    <div class="col-md-8 " >
                                        <h1 > <i class="fa fa-home text-30" role="generic"></i><span id="pageSpanHeadingShiftScheduleRegistration"> Shift Schedule Registration</span> </h1>
                                        <p id="pageSpanHeadingText1" class="RequiredStar">Please select whether or not you can go to work. The date once made available for work cannot be modified later.</p>
                                    </div>
                         	  ...
                         	  <div class="row  ml-2">
									<div class="col-md-12  pt-0 pr-4 TopButDiv">
										...
										<button id="btnThisMonthClick" class="DefaultButton btn btn-info TopButtonMinWidth mr-2" role='button'>
											<span id="spanBtnThisMonthShiftn">Shift In </span> <span id="spanBtnThisMonth"></span>
										</button> 
										<button id="btnNextMonthClick" class="DefaultButton btn btn-info TopButtonMinWidth mr-2" role='button'>
											<span id="spanBtnNextMonth"></span> <span id="buttonSpanOutputMatterList"> Shift</span>
										</button>
                             ...
                             <div class="row  ml-2">
                               <div class="col-md-12  pt-0 pr-4">
                                <span id="" class="text-20"><span id="spanUIThisMonth">November 2021 </span></span> &nbsp; <span id="spanAllChanged" class="text-15">All changed </span>
                                <span id="" class="text-20">
                                <select style="width: 100px;text-align:center;" id="shiftScheduleDetailOptionMaster">
                             ...
                             <div class="table-responsive pt-2">
								<table class="display table table-striped table-bordered hover" id="shiftScheduleDetailsTable" style="width: 100%">
									<thead>
										<tr>
										<th class="text-center" id="tableImplementationDetailsTHNo">Date</th>
										<th class="TableTHMinWidth text-center" id="tableImplementationDetailsTHDuplicateSelection">Yes/No</th>
										<th class="TableTHMinWidth text-center" id="tableImplementationDetailsTHImplementationPeriod">Remark</th>
										</tr>
									</thead>
                            ...
                            <div class="row  ml-2">
                               <div class="col-md-12  pt-0 pr-4">
                                 <span clas="RequiredStar">*</span><span id="spanBelowTextOne">The date set to work is not available for modification later.</span> 
                               </div>
                            </div>
                            <div class="row  ml-2">
                               <div class="col-md-12  pt-0 pr-4">
                                 <span clas="RequiredStar">*</span><span id="spanBelowTextTwo"> When you register the shift schedule, an email will be sent to the person in charge.</span> 
                               </div>
                            </div>
                            <div class="row  ml-2">
                            <form >
                            ...
                            <input type="hidden" name="selectedYear" id="selectedYear" value=""/>
								...
								<div class="col-md-12  pt-0 pr-4 TopButDiv">
									<button  id="btnRegisterShiftSchedule" onclick="registerShiftSchedule()" class="DefaultButton btn btn-info TopButtonMinWidth mr-2" role='button' >
										<span id="spanBtnRegisterShiftSchedule">Register a shift schedule</span>
									</button>
								</div>
							</div>
							 <br>
