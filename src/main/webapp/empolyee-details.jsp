...
<body class="text-left">
							...
							<div class="card-body p-0">
								<div class="row pt-4 mt-2 ml-2">
									...
									<div class="col-md-6 ">
										...
										<p class="pb-0 mb-0" id="pageSpanSubHeadingStaffDetails">Employee information can be modified</p>
									</div>
									<div class="col-md-6  ">
														...
														<button class="btn btn-link2 collapsed SDAccordion"
															...
															<div class="row">
																<div class="col-10" style="text-align: left;"
																	id="accordionDivEmployeeInformation">Employee Information</div>
													...
													<div class="card-body SDAccordionCardBody">
														<div class="row pb-2">
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																...
																<input type="text" id="staffName" class="form-control" maxlength="255"> 
																</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanTransferfinancialinstitutionname">Transfer Financial Institution Name</span>
																</div>
																<div>
																	<input type="text" id="Transferfinancialinstitutionname" class="form-control" >
																</div>
															</div>
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																...
																<div>
																	<input type="text" id="bankCode" class="form-control" maxlength="255"> 
																</div>
																...
																<div>
																	<input type="text" id="transferBranchname" class="form-control" maxlength="255">
																</div>
															</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanDateofjoiningthecompany">Date of joining the company </span>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanForNewPasswordConfirmation">For New Password Confirmation</span>
																	
																</div>
																<div>
																	<input type="text" id="newPasswordConfirmation" class="form-control"> 
																</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanValidclassification">Valid classification</span>
																</div>
																<div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanTerminationDate">Retirement date</span>
																</div>
																<div>
															...
															<div class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-3 mt-3 ContentAlignRC">
																<button 
																	...
																	id="buttonUpateEmployeeInformation">Update Employee</button>
															</div>
														</div>
	...
	<script>
	     ...
	     const  employeeID  =  "<%= request.getParameter("employeeID")%>" ;
			...
			$.ajax({
			 ...
			 let dataSet = '{"id" : "'+employeeID+'"}';
		        ...
		        $.ajax({
		            ...
		            url: serverHTTP +'Employee/ViewEmployee',
		            method: 'POST',
		            contentType: 'application/json',
		            data: dataSet,
		            dataType: 'json',
		...
		function  viewEmployee(result)
		{
			
			if(result.data1 != null)
			{
			 document.getElementById("employeeID").value = result.data1.id;
			 document.getElementById("staffName").value = result.data1.name;
			 document.getElementById("emailAddress").value = result.data1.email;
			 document.getElementById("Authority").value = result.data1.userRoleId;
 
			 //document.getElementById("newpassword").value = result.data1.name;
			 //
			}
			if(result.data2 != null)
			{
			  document.getElementById("remarks").value = result.data2.remark;
			  document.getElementById("dateofjoiningthecompany").value = result.data2.dateOfJoinInTheCompany;
			  document.getElementById("terminationDate").value = result.data2.dateOfLeavingTheCompany;
			  document.getElementById("superiorName").value = result.data2.inChargeStaff!= null ? result.data2.inChargeStaff :"";
			  document.getElementById("validclassification").value = result.data2.validClassification!= null ? result.data2.validClassification :"";
			}
			
			if(result.data3 != null)
			{
			  document.getElementById("Transferfinancialinstitutionname").value = result.data3.transferFinancialInstitutionName;
			  document.getElementById("bankCode").value = result.data3.bankCode;
			  document.getElementById("transferBranchname").value = result.data3.transferBranchName;
			  document.getElementById("branchCode").value = result.data3.branchCode;
			  document.getElementById("accountType").value = result.data3.accountType != null ? result.data3.accountType :"";
			  document.getElementById("accountNumber").value = result.data3.accountNumber;
			  document.getElementById("accountName").value = result.data3.accountName;
			}
			// Setting viewUuid
			sessionStorage.setItem("viewUuid",  result.data1.uuid);
		 }
		 ...
		 function updateEmployee()
		    {
			  ...
			  templateNameReqNode['id']   = document.getElementById("employeeID").value;
			  templateNameReqNode['uuid'] = uuid ;
		      templateNameReqNode['name'] = document.getElementById("staffName").value!="" ? document.getElementById("staffName").value : null ; 
		      templateNameReqNode['email'] = document.getElementById("emailAddress").value!="" ? document.getElementById("emailAddress").value : null ;
		      templateNameReqNode['authority'] = document.getElementById("Authority").value!="" ? document.getElementById("Authority").value : null ;
		      templateNameReqNode['transferFinancialInstitutionName'] = document.getElementById("Transferfinancialinstitutionname").value!="" ? document.getElementById("Transferfinancialinstitutionname").value : null ;
		      templateNameReqNode['transferBranchName'] = document.getElementById("transferBranchname").value!="" ? document.getElementById("transferBranchname").value : null ;
		      templateNameReqNode['bankCode'] = document.getElementById("bankCode").value!="" ? document.getElementById("bankCode").value : null ;
		      templateNameReqNode['branchCode'] = document.getElementById("branchCode").value!="" ? document.getElementById("branchCode").value : null ;
		      templateNameReqNode['accountType'] = document.getElementById("accountType").value!="" ? document.getElementById("accountType").value : null ;
		      templateNameReqNode['accountNumber'] = document.getElementById("accountNumber").value!="" ? document.getElementById("accountNumber").value : null ;
		      templateNameReqNode['accountName'] = document.getElementById("accountName").value!="" ? document.getElementById("accountName").value : null ;
		      templateNameReqNode['dateOfJoinInTheCompany'] = document.getElementById("dateofjoiningthecompany").value!="" ? document.getElementById("dateofjoiningthecompany").value : null ;
		      templateNameReqNode['SuperiorName'] = document.getElementById("superiorName").value!="" ? document.getElementById("superiorName").value : null ;
		      templateNameReqNode['password'] = document.getElementById("newpassword").value!="" ? document.getElementById("newpassword").value : null ; 
		      templateNameReqNode['validClassification'] = document.getElementById("validclassification").value!="" ? document.getElementById("validclassification").value : null ; 
		      templateNameReqNode['dateOfLeavingTheCompany'] = document.getElementById("terminationDate").value!="" ? document.getElementById("terminationDate").value : null ; 
		      templateNameReqNode['remark'] = document.getElementById("remarks").value.trim()!="" ? document.getElementById("remarks").value.trim() : null ;
			   ...
			   $.ajax({
		          ...
		          dataType: 'json',
		           ...
		           if(result.status==202)
		          	 {
						//document.getElementById("buttonUpateEmployeeInformation").disabled = true;
