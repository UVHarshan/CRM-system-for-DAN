   ...
   <script src="../dist-assets/js/language_main_staff.js"></script>
    ...
    function dailyDealForStaff(result)
    	...
    	if(result.data != "")
    	{
    		...
    		{
    		 contentRow ='<div onclick="viewTodayCase('+result.data[i].implementId+')" class="card card-icon-bg card-icon-bg-primary o-hidden  Color-3 cardBodyDiv p-4 m-2"><p><span class="text-16 text-center" id="spanTodayCaseName" name="spanTodayCaseName[]">Case Name : </span>'+result.data[i].caseName+'</p>'+
...
/*     		i=0;
    ...
    function viewTodayCase(implementId)
    {
