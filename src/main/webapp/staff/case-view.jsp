...
<body class="text-left" >
 <%@ include file="./common/CacheControl.jsp"%>
   ...
   <!--                            <div class="row  pt-2 ml-2 mr-2">
                              ...
                              <div class="row  pt-2 ml-2 mr-2">
                               ...
                               <div class="col-md-8 pt-0 pr-4">
                                 <button  class="DefaultButton btn btn-info TopButtonMinWidth mr-2" id="buttonOutputWorkingConditionNotification"  role='button'>
                              ...
                              <div class="row  pt-2 ml-2 mr-2">
                               ...
                               <div class="col-md-8 pt-0 pr-4">
                                 <button  class="DefaultButton btn btn-info TopButtonMinWidth mr-2" id="buttonConfirmationWorkingConditionNotification" role='button'>
    ...
    /*   const staffID = localStorage.getItem('staffID') ;
      ...
      const assignmentIdConst = "<%= request.getParameter("assignmentId")%>" ;
 ...
 /* 	  dataNodeLoad["staffId"] = staffID ; 
	  ...
	  dataNodeLoad["assignmentId"] = assignmentIdConst ; 
    ...
    function viewimplementDetail(result)
    {
    	 ...
    	 buttonDisableForConfirmation(result.data[0].reportDayBeforeStatus, result.data[0].departureReportStatus, result.data[0].arrivalReportStatus, result.data[0].closingReportStatus,result.data[0].confirmationOfWorkingCondition);
    	 if(result.data[0].absenceReportStatus)
    	 {
    		 ...
    		 document.getElementById("inputScheduledDepartureTime").disabled = true;
    	 ...
    	 if(result.data[0].assignmentClassification == 1 )
         {
    		 document.getElementById("divAbsentSection").style.display = "none";  
         }		 
    ...
    $("#buttonOutputWorkingConditionNotification").click(function( event ) { 
 
		 let implementDate = document.getElementById("spanImplementationDateContent").innerHTML;	   
		 let dataNode = {};     
	   	 dataNode['implementId'] = implementId;
	    	   ...
	    	   $.ajax({
	             ...
	             url: serverHTTP +'Assignment/WorkingConditionCSVOutput',
	             method: 'POST',
	             contentType: 'application/json',
    ...
    $("#buttonConfirmationWorkingConditionNotification").click(function( event ) { 
		 ...
		 let dataNode = {};     
	  	 dataNode['assignmentId'] = assignmentId;  
	    	   $.ajax({
	             ...
	             url: serverHTTP +'Assignment/ConfirmationOfWorkingCondition',
	             method: 'POST',
	             contentType: 'application/json',
	             data: JSON.stringify(dataNode),
	             dataType: 'json',
				 ...
				 if(result.status==200)
	             {
					...
					document.getElementById("buttonConfirmationWorkingConditionNotification").disabled = true;
	             }
	              else
	              {
	              	showMessage('error',"N1265");
    ...
    $("#ButtonSpanConfirmedDayBefore").click(function( event ) { 
		 ...
		 let implementDate = document.getElementById("spanImplementationDateContent").innerHTML;
		 let assignmentId = document.getElementById("assignmentIdValue").value;
		 let scheduledDepartureTime = document.getElementById("inputScheduledDepartureTime").value;
		 ...
		 let dataNode = {};     
 	     ...
 	     dataNode['departureTime'] = scheduledDepartureTime;
	    	   ...
	    	   $.ajax({
				 ...
				 if(result.status==200)
	             {
	              	...
	              	document.getElementById("ButtonSpanConfirmedDayBefore").disabled = true;
	              	document.getElementById("ButtonSpanReportDeparture").disabled = false;
	             }
	              else
	              {
	              	showMessage('error',"N1265");
	     ...
	     dataNode['implementDate'] = implementDate;  
	    	   ...
	    	   $.ajax({
				 ...
				 if(result.status==200)
	             {
	              	...
	              	document.getElementById("ButtonSpanReportArrival").disabled = false;
	             }
	              else
	              {
	              	showMessage('error',"N1265");
	     ...
	     dataNode['implementDate'] = implementDate;  
	    	   ...
	    	   $.ajax({
				 ...
				 if(result.status==200)
	             {
	              	...
	              	document.getElementById("ButtonSpanReportClosing").disabled = false;
	             }
	              else
	              {
	              	showMessage('error',"N1265");
	...
	function buttonDisableForConfirmation(value1, value2, value3, value4,confirmationOfWorkingCondition)
	{
		//wishwa
		document.getElementById("ButtonSpanReportClosing").disabled = true;
		document.getElementById("ButtonSpanReportDeparture").disabled = true;
		...
		if(confirmationOfWorkingCondition==1)
		{
			document.getElementById("buttonConfirmationWorkingConditionNotification").disabled = true;
		}
