...
<title id="pageTitleDailyIncomeTaxesRegistration">Daily Income Taxes
	Registration</title>
<link
...
<body class="text-left">
									...
									<div class="col-md-6 ">
										<h1>
											<i class="fa fa-calculator text-30" role="generic"></i><span
												id="pageSpanHeadingIncomeTaxDailyRegistration"> Income Tax Daily Registration </span>
										</h1>

										<p class="pb-0 mb-0"
											id="pageSpanSubHeadingIncomeTaxDailyRegistration">You can
											add the details of the daily income tax amount.</p>
									</div>
									<div class="col-md-6">
													...
													<div class="row pb-4">
														...
														<div
															...
															<button
																...
																id="buttonTaxDailySaveDailyIncomeTaxDetails">Save Daily Income Tax Details</button>
														</div>
	...
	<script src="./dist-assets/js/daily-income-taxes-registration-validate.js"></script>
    	  ...
    	  $.ajax({
              ...
              dataType: 'json',
               ...
               if(result.status==200)
              	 {
            	   document.getElementById("buttonTaxDailySaveDailyIncomeTaxDetails").disabled = true;
