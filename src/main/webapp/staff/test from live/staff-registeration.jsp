														...
														<button class="btn btn-link2 collapsed SDAccordion"
															...
															<div class="row">
																<div class="col-10" style="text-align: left;"
																	id="accordionDivStaffInformation">Staff Information</div>
													...
													<div class="card-body SDAccordionCardBody">
														<div class="row pb-4">
                                                          ...
                                                          <button class="btn SuccessColor ml-1">Adress Search</button>
																	...
																	<button onclick="getAddressStaff('staffZipCode','staffAddress')" class="btn btn-info"
																		id="btnAddressSearch">Address Search</button>
																	<span id="pageSpanHelpZipCode"> Please enterwithout hyphens</span>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<Select id="staffPrefecture" class="form-control"
																		required>
																		<option value="" id="pageOption0Prefecture">Select Prefecture</option>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="text" id="staffAddress" class="form-control"> 
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanAddressKatakana">Address Katakana</span>
																	<span class="RequiredStar">*</span>
																</div>
																<div>
																	<input type="text" id="staffAddressKatakana" class="form-control">
																</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanGender">Gender</span>
																	<span class="RequiredStar">*</span>
																</div>
																<div>
																	<Select id="staffGender" class="form-control">
																		<option value="" id="selectOptionSelectGender_1">Select Gender</option>
				                                                         <option value="1" id="selectOptionSelectGenderMale_1">Male</option>
				                                                         <option value="2" id="selectOptionSelectGenderFemale_1">Female</option>
																	</Select>
																</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanMobile">Mobile</span>
																	<span class="RequiredStar">*</span>
																</div>
																<div>
																	<input type="text" id="staffMobile" class="form-control"> 
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanHomeParent"> Home (parent's home)</span>
																</div>
																<div>
																	<input type="text" id="staffHomeTel" class="form-control"> 
																	<span id="pageSpanHelpHome"> Please enter without hyphens</span>
																</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanAttributeclassification1">Attribute classification 1</span>
																	<span class="RequiredStar">*</span>
																</div>
																<div>
																	<Select id="staffAttributeclassification1" class="form-control">
																		<option value="" id="pageOption0AttributeClassification1">Select Attribute classification 1</option>
																		<option value="1" id="pageOption1AttributeClassification1"> Inhouse Company Affiliated Staff</option>
																		<option value="2" id="pageOption2AttributeClassification1">Out Sourcing</option>
																	</Select>
																</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanAttributeclassification2">Attribute classification 2</span>
																</div>
																<div>
																	<Select id="staffAttributeclassification2" class="form-control">
																		<option value="" id="pageOption0AttributeClassification2">Select Attribute classification 2</option>
																		<option value="1" id="pageOption1AttributeClassification2">Fixed-term employment worker</option>
																		<option value="2" id="pageOption2AttributeClassification2">Fixed-term employment workers(Dispatched Workers Subject to the agrrement</option>
																		<option value="3" id="pageOption3AttributeClassification2">Permanent Worker</option>
																		<option value="4" id="pageOption4AttributeClassification2">Permanent Employment Workers(Dispatched Workers Subject to the agrrement</option>															
																	</Select>
																</div>
                                                             ...
                                                             <div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3" >
                                                                  <div class="DetailsTitleText"><span id="pageSpanLaborManagementExpirationDate">Labor-management agreement expiration date</span>  </div>
                                                                  <div><input type="date" id="staffLaborManagementAgreementExpirationDate" class="form-control"></div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<Select id="staffAttribute" class="form-control">
																		<option value="" id="pageOption0Attribute">Select Attribute</option>
																		<option value="1" id="pageOption1Attribute">Elderly</option>
																		<option value="2" id="pageOption2Attribute">Foreign Student</option>
																		<option value="3" id="pageOption3Attribute">Foreign worker</option>
													...
													<div class="card-body SDAccordionCardBody">
														<div class="row pt-3 pb-3">
															<div class="col-sm-12 col-md-3 col-lg-3 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanEducationalBackground">Educational Background </span>
																</div>
															</div>
																	...
																	<table
																		...
																		<tbody id="educationalTbodyId">
																			<tr id="educationalTrId">
																				...
																				<input type="hidden" name="staffEducationalID[]"
																					class="form-control">
																				<input type="month" name="staffEducationalBackgroundDateFrom[]"
																					class="form-control"></td>
																				<td style="width: 15%;" class="p-1"><input
																					type="month" name="staffEducationalBackgroundDateTo[]"
																					class="form-control"></td>
																				<td class="p-1"><input type="text" name="staffInstitute[]"
																					class="form-control"></td>
																				<td class="p-1" >
																				<input type="text" name="staffQualification[]" class="form-control">
																				</td>
																				<td >
																				    <button class="btn btn-danger" onclick="removeEducationalRow(this)"><i class="fa fa-trash"></i></button>
																				    <button class="btn btn-danger" onclick="clearRow(this)"><i class="fa fa-eraser"></i></button>
																				</td>
																			</tr>
																		</tbody>
																	  </table>
																	  <div id="errorEducationalBackground" class="RequiredStar"></div>
																	 
															     <div class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-0 ContentAlignRC">
																    <button class="btn SuccessColor" onclick="addEducationalRow()" id="addEducationalRow">Add Row</button>
															     </div>
															  </div>
															</div>
														</div>
														...
														<div class="row pt-3 pb-3">
															...
															<div class="col-sm-12 col-md-12 col-lg-12">
																<div class="table-responsive">
																	<table
																		...
																		<tbody id="workTbodyId">
																			<tr id="workTrId">
																			    <input type="hidden" name="staffWorkHistoryCredentialsID[]">
																				<td style="width: 15%;" class="p-1"><input
																					type="month" id="staffWorkHistoryDateFrom" name="staffWorkHistoryCredentialsDateFrom[]"
																					class="form-control"></td>
																				<td style="width: 15%;" class="p-1"><input
																					type="month" id="staffWorkHistoryDateTo" name="staffWorkHistoryCredentialsDateTo[]"
																					class="form-control"></td>
																				<td class="p-1"><input type="text" id="staffDesignation" name="staffDesignationCredentials[]"
																					class="form-control"></td>
																				<td class="p-1"><input type="text" id="staffCompanyName" name="staffCompanyNameCredentials[]"
																					class="form-control"></td>
																				<td class="p-1"><input type="text" id="staffExperienceType" name="staffExperienceTypeCredentials[]"
																					class="form-control"></td>
																				<td >
																				    <button class="btn btn-danger" onclick="removeWorkRow(this)"><i class="fa fa-trash"></i></button>
																				    <button class="btn btn-danger" onclick="clearRow(this)"><i class="fa fa-eraser"></i></button>
																				</td>
																			</tr>
																		</tbody>
																...
																<div class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-0 ContentAlignRC">
																    <button class="btn SuccessColor" onclick="addWorkRow()" id="addWorkRow">Add Row</button>
															     </div>
																</div>
															</div>
														</div>
																	...
																	<table
																		...
																		<thead>
																			<tr>
																				...
																				<th id="tableLicenseTHLicenseQualification">License Qualification</th>
																				<th id="tableLicenseTHLicenseNumber">License Number</th>
																				<th id="tableLicenseTHLiContents">License Operating Item</th>
																				<th style="width: 95px;"></th>
																			</tr>
																		</thead>
																		<tbody id="licenceTbodyId">
																			<tr id="licenceTrId">
																			   <input type="hidden" name="licenseQualificationID[]">
																				<td style="width: 15%;" class="p-1"><input
																					type="month" id="staffLicenseQualificationDateFrom" name="staffLicenseQualificationDateFrom[]"
																					class="form-control"></td>
																				<td style="width: 15%;" class="p-1"><input
																					type="month" id="staffLicenseQualificationDateTo" name="staffLicenseQualificationDateTo[]"
																					class="form-control"></td>
																				<td class="p-1"><input type="text" id="staffLicenceQualification" name="staffLicenceQualification[]"
																					class="form-control"></td>
																				<td class="p-1"><input type="text" id="staffLicenceNumber" name="staffLicenceNumber[]"
																					class="form-control"></td>
																				<td class="p-1"><input type="text" id="staffLicenceOperatingItem" name="staffLicenceOperatingItem[]"
																					class="form-control"></td>
																				<td >
																				    <button class="btn btn-danger" onclick="removeLicenceRow(this)"><i class="fa fa-trash"></i></button>
																				    <button class="btn btn-danger" onclick="clearRow(this)"><i class="fa fa-eraser"></i></button>
																				</td>	
																			</tr>
																		</tbody>																		
																	</table>
																	<div id="errorLicenseQualification" class="RequiredStar"></div>
																	
																<div class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-0 ContentAlignRC">
																    <button class="btn SuccessColor" onclick="addLicenseRow()" id="addLicenseRow">Add Row</button>
															     </div>
																</div>
															</div>
														</div>
                                                     ...
                                                     <div class="row pt-3 pb-3">
													  <div class="col-sm-12 col-md-6 col-lg-6 pl-3 pr-3">
                                                        <div class="DetailsTitleText" id="pageSpanCVFileUpload">CV File Upload</div>
                                                        <div>
                                                           <form method="POST" enctype="multipart/form-data" id="fileUploadForm">
														     <input type="file" id="staffCvPdf" class="form-control" >
														...
														<div class="row pt-3 pb-3">
															<div
																...
																<button onclick="checkResume()" class="btn DefaultButton btn-info TopButtonMinWidth" id="buttonSaveResumeInformation">Save Resume Information</button>
															</div>
														</div>
												...
												<div class="card-header  pt-2 pb-2" id="headingThree">
													<h5 class="mb-0">
														<button class="btn btn-link2 collapsed SDAccordion"
															...
															<div class="row">
																<div class="col-10" style="text-align: left;" id="accordionDivPayrollInformation">Payroll Information</div>
																<div class="col-2" style="text-align: right;">
																	<i class="fa fa-chevron-down" aria-hidden="true"></i>
																</div>
															</div>
												...
												<div id="payroleInformation" class="collapse"
													...
													<div class="card-body SDAccordionCardBody">
														<div class="row pb-3">
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanDailySalaryUnitPrice">Daily salary unit price</span>
																</div>
																<div>
																	<input type="number" id="dailySalary" class="form-control"> 
																	<span id="pageSpanHelpDailySalaryUnitPrice">* This unit price will be referred to when the paid calculation method is set to regular wages.</span>
																</div>
																<div id="errorDailySal" style="color: red;"></div>
															</div>
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanHourlyWageUnitPrice">Hourly Wage Unit Price</span>
																</div>
																<input type="number" id="staffHourlyWageUnitPrice" class="form-control">
																<span id="pageSpanHelpHourlyWageUnitPrice">* Enter this if the unit price is fixed regardless of the job description.</span>                                                          
															...
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanSalaryPaymentMethod">Salary Payment Method</span><span class="RequiredStar"> *</span>
																</div>
																<div>
																	<Select id="staffPaymentMethod" class="form-control">
																		<option value="0" id="selectOption">Select Salary Payment Method</option>
																		<option value="1" id="selectOptionPersonalDelivery">Personal delivery</option>
																		<option value="2" id="selectOptionTransfer">Transfer</option>
																	</Select> <span id="pageSpanHelpSalaryPaymentMethod">If you choose to transfer, please enter your account information</span>
																</div>
																<div id="errorSalaryPay" style="color: red;"></div>
															</div>
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanSalaryPaymentForm">Salary Payment Form</span> 
																	<span class="RequiredStar"> *</span>
																</div>
																<div>
																	<Select id="staffSalaryPaymentForm"
																		class="form-control">
																		<option value="0" id="selectOptionSalary">Select Salary Payment Form</option>
																		<option value="1" id="selectOptionSalaryPaymentFormDailyWeekly">Daily / Weekly payment</option>
																		<option value="2" id="selectOptionSalaryPaymentFormMonthly">Monthly Payment</option>
																	</Select>
																</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanSalaryClosingDate">Salary Closing Date</span>
																</div>
																<div>
																<div class="form-group">
																<Select id="staffSalaryClosingDate" class="form-control">
                                                                <option value="" id="selectOptionSalaryClosingDate">Select Salary Closing Date</option>
                                                                <option value="28" id="selectOptionSalaryClosingDateTheEndOfTheMonth">The end of the month</option>
                                                                <option value="1" id="selectOptionSalaryClosingDate1Day">1 day</option>
                                                                <option value="2" id="selectOptionSalaryClosingDate2Day">2 days</option>
                                                                <option value="3" id="selectOptionSalaryClosingDate3Day">3 days</option>
                                                                <option value="4" id="selectOptionSalaryClosingDate4Day">4 days</option>
                                                                <option value="5" id="selectOptionSalaryClosingDate5Day">5 days</option>
                                                                <option value="6" id="selectOptionSalaryClosingDate6Day">6 days</option>
                                                                <option value="7" id="selectOptionSalaryClosingDate7Day">7 days</option>
                                                                <option value="8" id="selectOptionSalaryClosingDate8Day">8 days</option>
                                                                <option value="9" id="selectOptionSalaryClosingDate9Day">9 days</option>
                                                                <option value="10" id="selectOptionSalaryClosingDate10Day">10 days</option>
                                                                <option value="11" id="selectOptionSalaryClosingDate11Day">11 days</option>
                                                                <option value="12" id="selectOptionSalaryClosingDate12Day">12 days</option>
                                                                <option value="13" id="selectOptionSalaryClosingDate13Day">13 days</option>
                                                                <option value="14" id="selectOptionSalaryClosingDate14Day">14 days</option>
                                                                <option value="15" id="selectOptionSalaryClosingDate15Day">15 days</option>
                                                                <option value="16" id="selectOptionSalaryClosingDate16Day">16 days</option>
                                                                <option value="17" id="selectOptionSalaryClosingDate17Day">17 days</option>
                                                                <option value="18" id="selectOptionSalaryClosingDate18Day">18 days</option>
                                                                <option value="19" id="selectOptionSalaryClosingDate19Day">19 days</option>
                                                                <option value="20" id="selectOptionSalaryClosingDate20Day">20 days</option>
                                                                <option value="21" id="selectOptionSalaryClosingDate21Day">21 days</option>
                                                                <option value="22" id="selectOptionSalaryClosingDate22Day">22 days</option>
                                                                <option value="23" id="selectOptionSalaryClosingDate23Day">23 days</option>
                                                                <option value="24" id="selectOptionSalaryClosingDate24Day">24 days</option>
                                                                <option value="25" id="selectOptionSalaryClosingDate25Day">25 days</option>
                                                                <option value="26" id="selectOptionSalaryClosingDate26Day">26 days</option>
                                                                <option value="27" id="selectOptionSalaryClosingDate27Day">27 days</option>
                                                                <option value="28" id="selectOptionSalaryClosingDate28Day">28 days</option>  
                                                                </Select>
																</div>
																</div>
															</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<Select id="staffPaidTarget" class="form-control">
																		<option value="" id="selectOptionPaidTarget">Select Paid Target</option>
														...
														<div class="row pb-4" id="transferMainDiv"
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanTransferFinancialInstitution">Transfer Financial Institution Name</span>
																		<span class="RequiredStar">*</span>
																</div>
																<div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanTransferBranchName">Transfer Branch Name</span>
																		<span class="RequiredStar">*</span>
																</div>
																<div>
																	<input type="text" id="staffBranchName" class="form-control"> 
																	<span id="pageSpanHelpTransferBranchName">For Japan Post Bank, enter the store name (example: 1988)</span>
																</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="number" id="staffBankCode" class="form-control">
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="number" id="staffBranchCode" class="form-control">
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<Select id="staffAccountType" class="form-control">
																		<option value="0" id="selectOptionAccountType">Select Account Type</option>
																		<option value="1"
																			id="selectOptionAccountTypeUsually">Usually</option>
																		<option value="2"
																			id="selectOptionAccountTypeCurrent">Current</option>
																		<option value="3"
																			id="selectOptionAccountTypeSavings">Savings</option>
																		<option value="4"
																			id="selectOptionAccountTypeOthers">Others</option>
																	</Select>
																</div>
                                                        ...
                                                        <div class="row pt-3 pb-3">
															<div
																...
																class="btn DefaultButton btn-info TopButtonMinWidth"
																id="buttonSavePayrollInformation">Save
																Payroll Information</button>
															</div>
														</div>
												...
												<div class="card-header  pt-2 pb-2" id="headingOne">
													<h5 class="mb-0">
														<button class="btn btn-link2 collapsed SDAccordion"
															...
															<div class="row">
																<div class="col-10" style="text-align: left; white-space: pre-line;" id="accordionDivSocialInsuranceInformation">
																	Social Insurance / Income Tax / Resident Tax Information</div>
																<div class="col-2" style="text-align: right;">
																	<i class="fa fa-chevron-down" aria-hidden="true"></i>
																</div>
															</div>
												...
												<div id="insuranceTaxInformation" class="collapse"
													...
													<div class="card-body SDAccordionCardBody">
														<div class="row pb-4">
															...
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSocialInsuranceCoverage"> Social insurance Coverage</span> <span class="RequiredStar">*</span>
																</div>
																<div>
																	<Select id="staffSocialInsuranceCoverage" class="form-control">
																	    <option value="" id="selectOptionSocialInsuranceCoverage">Select Social Insurance Coverage</option>
																		<option value="1" id="selectOptionSocialInsuranceCoverageNotSubscribed">Not Subscribed</option>
																		<option value="2" id="selectOptionSocialInsuranceCoverageSubscribed">Subscribed</option>
																	</Select>
																</div>
																<div id="errorSocialInsurance" style="color: red;"></div>
															</div>

															<div class="col-sm-12 col-md-12 col-lg-12  p-3" id="pageSpanOpensocialinsurance">insurance / income tax / resident tax information</a></div>

															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText" id="pageSpanHealthInsuranceCoverage">Health insurance coverage</div>
																<div>
																	<Select id="staffHealthInsuranceCoverage" class="form-control">
																	     <option value="" id="selectOptionHealthInsuranceCoverage">Select Health insurance coverage</option>
																		<option value="1" id="selectOptionHealthInsuranceCoverageNotSubscribed">NotSubscribed</option>
																		<option value="2" id="selectOptionHealthInsuranceCoverageSubscribed">Subscribed</option>
																	</Select>
																</div>
															</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText"
																	id="pageSpanHealthInsuranceGrade">Health insurance grade</div>
																<div>
																	<Select id="staffHealthInsuranceGrade"
																		class="form-control">
																		<option value="" id="selectOptionHealthInsuranceGrade">Select Health insurance grade</option>
																		<option value="1" id="selectOptionHealthInsuranceGradeNotSubscribed">Not Subscribed</option>
																		<option value="2" id="selectOptionHealthInsuranceGradeGrade1" >Grade 1 to 63,000</option>
																		<option value="3" id="selectOptionHealthInsuranceGradeGrade2">2nd Grade 63,000 to 73,000</option>
																		<option value="4" id="selectOptionHealthInsuranceGradeGrade3">3rd Grade 73,000 to 83,000</option>
																		<option value="5" id="selectOptionHealthInsuranceGradeGrade4">4th Grade 83,000 to 93,000</option>
																		<option value="6" id="selectOptionHealthInsuranceGradeGrade5">5th Grade 93,000 to 101,000</option>
																		<option value="7" id="selectOptionHealthInsuranceGradeGrade6">6th Grade 101,000 to 107,000</option>
																		<option value="8" id="selectOptionHealthInsuranceGradeGrade7">7th Grade 107,000 to 114,000</option>
																		<option value="9" id="selectOptionHealthInsuranceGradeGrade8">8th Grade 114,000 to 122,000</option>
																		<option value="10" id="selectOptionHealthInsuranceGradeGrade9">9th Grade 122,000 to 130,000</option>
																		<option value="11" id="selectOptionHealthInsuranceGradeGrade10">10th Grade 130,000 to 138,000</option>
																		<option value="12" id="selectOptionHealthInsuranceGradeGrade11">11th Grade 138,000 to 146,000</option>
																		<option value="13" id="selectOptionHealthInsuranceGradeGrade12">12th Grade 146,000 to 155,000</option>
																		<option value="14" id="selectOptionHealthInsuranceGradeGrade13">13th Grade 155,000 to 165,000</option>
																		<option value="15" id="selectOptionHealthInsuranceGradeGrade14">14th Grade 165,000 to 175,000</option>
																		<option value="16" id="selectOptionHealthInsuranceGradeGrade15">15th Grade 175,000 to 185,000</option>
																		<option value="17" id="selectOptionHealthInsuranceGradeGrade16">16th Grade 185,000 to 195,000</option>
																		<option value="18" id="selectOptionHealthInsuranceGradeGrade17">17th Grade 195,000 to 210,000</option>
																		<option value="19" id="selectOptionHealthInsuranceGradeGrade18">18th Grade 210,000 to 230,000</option>
																		<option value="20" id="selectOptionHealthInsuranceGradeGrade19">19th Grade 230,000 to 250,000</option>
																		<option value="21" id="selectOptionHealthInsuranceGradeGrade20">20th Grade 250,000 to 270,000</option>
																		<option value="22" id="selectOptionHealthInsuranceGradeGrade21">21st Grade 270,000 to 290,000</option>
																		<option value="23" id="selectOptionHealthInsuranceGradeGrade22">22nd Grade 290,000 to 310,000</option>
																		<option value="24" id="selectOptionHealthInsuranceGradeGrade23">23rd Grade 310,000 to 330,000</option>
																		<option value="25" id="selectOptionHealthInsuranceGradeGrade24">24th Grade 330,000 to 350,000</option>
																		<option value="26" id="selectOptionHealthInsuranceGradeGrade25">25th Grade 350,000 to 370,000</option>
																		<option value="27" id="selectOptionHealthInsuranceGradeGrade26">26th Grade 370,000 to 395,000</option>
																		<option value="28" id="selectOptionHealthInsuranceGradeGrade27">27th Grade 395,000 to 425,000</option>
																		<option value="29" id="selectOptionHealthInsuranceGradeGrade28">28th Grade 425,000 to 455,000</option>
																		<option value="30" id="selectOptionHealthInsuranceGradeGrade29">29th Grade 455,000 to 485,000</option>
																		<option value="31" id="selectOptionHealthInsuranceGradeGrade30">30th Grade 485,000 to 515,000</option>
																		<option value="32" id="selectOptionHealthInsuranceGradeGrade31">31st Grade 515,000 to 545,000</option>
																		<option value="33" id="selectOptionHealthInsuranceGradeGrade32">32nd Grade 545,000 to 575,000</option>
																		<option value="34" id="selectOptionHealthInsuranceGradeGrade33">33rd Grade 575,000 to 605,000</option>
																		<option value="35" id="selectOptionHealthInsuranceGradeGrade34">34th Grade 605,000 to 635,000</option>
																		<option value="36" id="selectOptionHealthInsuranceGradeGrade35">35th Grade 635,000 to 665,000</option>
																		<option value="37" id="selectOptionHealthInsuranceGradeGrade36">36th Grade 665,000 to 695,000</option>
																		<option value="38" id="selectOptionHealthInsuranceGradeGrade37">37th Grade 695,000 to 730,000</option>
																		<option value="39" id="selectOptionHealthInsuranceGradeGrade38">38th Grade 730,000 to 770,000</option>
																		<option value="40" id="selectOptionHealthInsuranceGradeGrade39">39rd Grade 770,000 to 810,000</option>
																		<option value="41" id="selectOptionHealthInsuranceGradeGrade40">40th Grade 810,000 to 855,000</option>
																		<option value="42" id="selectOptionHealthInsuranceGradeGrade41">41st Grade 855,000 to 905,000</option>
																		<option value="43" id="selectOptionHealthInsuranceGradeGrade42">42nd Grade 905,000 to 965,000</option>
																		<option value="44" id="selectOptionHealthInsuranceGradeGrade43">43rd Grade 965,000 to 1,005,000</option>
																		<option value="45" id="selectOptionHealthInsuranceGradeGrade44">44th Grade 1,005,000 to 1,055,000</option>
																		<option value="46" id="selectOptionHealthInsuranceGradeGrade45">45th Grade 1,055,000 to 1,115,000</option>
																		<option value="47" id="selectOptionHealthInsuranceGradeGrade46">46th Grade 1,115,000 to 1,175,000</option>
																		<option value="48" id="selectOptionHealthInsuranceGradeGrade47">47th Grade 1,175,000 to 1,235,000</option>
																		<option value="49" id="selectOptionHealthInsuranceGradeGrade48">48th Grade 1,235,000 to 1,295,000</option>
																		<option value="50" id="selectOptionHealthInsuranceGradeGrade49">49th Grade 1,295,000 to 1,355,000</option>
																		<option value="51" id="selectOptionHealthInsuranceGradeGrade50">50th Grade 1,355,000 ~ </option>
																	</Select>
																</div>
															</div>

															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText" id="pageSpanWelfarePensionInsurance">Welfare pension insurance participation status</div>
																<div>
																	<Select id="staffWelfarePensionStatus" class="form-control">
																	    <option value="" id="selectOptionWelfareHealthInsuranceCoverage">Select Welfare pension insurance participation status</option>
                                                            			<option value="1" id="selectOptionWelfareHealthInsuranceCoverageNotSubscribed">Not Subscribed</option>
                                                           				 <option value="2" id="selectOptionWelfareHealthInsuranceCoverageSubscribed" >Subscribed</option>
                                                        			</Select>
																</div>
															</div>

															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText" id="pageSpanWelfarePensionInsuranceGrade">Welfare pension insurance grade</div>
																<div>
																	<Select id="staffWelfarePensionGrade" class="form-control">
																	      <option value="" id="selectOptionWelfarePensionInsuranceGrade">Select Welfare pension insurance grade</option>
                                                            <option value="1" id="selectOptionWelfarePensionInsuranceGradeNotSubscribed">Not Subscribed</option>
                                                            <option value="2" id="selectOptionWelfarePensionInsuranceGrade2" >Grade 1 - 93,000</option>
                                                            <option value="3" id="selectOptionWelfarePensionInsuranceGrade3">2nd Grade 93,000 - 101,000</option>
                                                            <option value="4" id="selectOptionWelfarePensionInsuranceGrade4">3rd Grade 101,000 - 107,000</option>
                                                            <option value="5" id="selectOptionWelfarePensionInsuranceGrade5">4th Grade 107,000 - 114,000</option>
                                                            <option value="6" id="selectOptionWelfarePensionInsuranceGrade6">5th Grade 114,000 - 122,000</option>
                                                            <option value="7" id="selectOptionWelfarePensionInsuranceGrade7">6th Grade 122,000 - 130,000</option>
                                                            <option value="8" id="selectOptionWelfarePensionInsuranceGrade8">7th Grade 130,000 - 138,000</option>
                                                            <option value="9" id="selectOptionWelfarePensionInsuranceGrade9">8th Grade 138,000 - 146,000</option>
                                                            <option value="10" id="selectOptionWelfarePensionInsuranceGrade10">9th Grade 146,000 - 155,000</option>
                                                            <option value="11" id="selectOptionWelfarePensionInsuranceGrade11">10th Grade 155,000 - 165,000</option>
                                                            <option value="12" id="selectOptionWelfarePensionInsuranceGrade12">11th Grade 165,000 - 175,000</option>
                                                            <option value="13" id="selectOptionWelfarePensionInsuranceGrade13">12th Grade 175,000 - 185,000</option>
                                                            <option value="14" id="selectOptionWelfarePensionInsuranceGrade14">13th Grade 185,000 - 195,000</option>
                                                            <option value="15" id="selectOptionWelfarePensionInsuranceGrade15">14th Grade 195,000 - 210,000</option>
                                                            <option value="16" id="selectOptionWelfarePensionInsuranceGrade16">15th Grade 210,000 - 230,000</option>
                                                            <option value="17" id="selectOptionWelfarePensionInsuranceGrade17">16th Grade 230,000 - 250,000</option>
                                                            <option value="18" id="selectOptionWelfarePensionInsuranceGrade18">17th Grade 250,000 - 270,000</option>
                                                            <option value="19" id="selectOptionWelfarePensionInsuranceGrade19">18th Grade 270,000 - 290,000</option>
                                                            <option value="20" id="selectOptionWelfarePensionInsuranceGrade20">19th Grade 290,000 - 310,000</option>
                                                            <option value="21" id="selectOptionWelfarePensionInsuranceGrade21">20th Grade 310,000 - 330,000</option>
                                                            <option value="22" id="selectOptionWelfarePensionInsuranceGrade22">21st Grade 330,000 - 350,000</option>
                                                            <option value="23" id="selectOptionWelfarePensionInsuranceGrade23">22nd Grade 350,000 - 370,000</option>
                                                            <option value="24" id="selectOptionWelfarePensionInsuranceGrade24">23rd Grade 370,000 - 395,000</option>
                                                            <option value="25" id="selectOptionWelfarePensionInsuranceGrade25">24th Grade 395,000 - 425,000</option>
                                                            <option value="26" id="selectOptionWelfarePensionInsuranceGrade26">25th Grade 425,000 - 455,000</option>
                                                            <option value="27" id="selectOptionWelfarePensionInsuranceGrade27">26th Grade 455,000 - 485,000</option>
                                                            <option value="28" id="selectOptionWelfarePensionInsuranceGrade28">27th Grade 485,000 - 515,000</option>
                                                            <option value="29" id="selectOptionWelfarePensionInsuranceGrade29">28th Grade 515,000 - 545,000</option>
                                                            <option value="30" id="selectOptionWelfarePensionInsuranceGrade30">29th Grade 545,000 - 575,000</option>
                                                            <option value="31" id="selectOptionWelfarePensionInsuranceGrade31">30th Grade 575,000 - 605,000</option>
                                                            <option value="32" id="selectOptionWelfarePensionInsuranceGrade32">31st Grade 605,000 ~</option>
                                                      </Select>
																</div>
															</div>

															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText" id="pageSpanLongTermCareInsuranceParticipation">Long-term care insurance participation status</div>
																<div>
																	<Select id="staffLongTermInsuranceStatus" class="form-control">
																	       <option value="" id="selectOptionLongTermInsuranceStatus">Select Long-term care insurance participation status</option>
                                                           <option value="1" id="selectOptionLongTermInsuranceStatus1">Not Subscribed</option>
                                                           <option value="2" id="selectOptionLongTermInsuranceStatus2">Subscribed</option>
				                                                    </Select>
																</div>
															</div>
															...
															<div
																class="col-sm-12 col-md-12 col-lg-12  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText" id="pageSpanEmploymentInsuranceCoverage">Employment insurance coverage</div>
																<div>
																	<Select id="staffEmploymentInsuranceCoverage" class="form-control">
																	        <option value="" id="selectOptionEmploymentInsuranceCoverage">Select Employment insurance coverage</option>
				                                                            <option value="1" id="selectOptionEmploymentInsuranceCoverageNotSubscribed" >Not Subscribed</option>
				                                                            <option value="2" id="selectOptionEmploymentInsuranceCoverageSubscribed" >Subscribed</option>
				                                                    </Select>
                                                            <span id="pageSpanHelpEmploymentInsuranceCoverage1">
															...
															<div
																...
																<div>
																	<Select id="staffIncomeTaxTaxpayer" class="form-control">
				                                                            <option value="" id="selectIncomeTaxTaxpayer">Select Income tax taxpayer classification</option>
															...
															<div
																...
																<div class="DetailsTitleText"
																	id="pageSpanDependents">Dependents</div>
																...
																<div class="table-responsive">
																	<table
																		...
																		<thead>
																			<tr>
																				<th id="tableConflictDateTHFamilyName">family name</th>
																				<th id="tableConflictDateTHNameKatakana">Name katakana</th>
																				...
																				<th id="tableConflictDateTHLivingTogether">Living together</th>
																				<th id="tableConflictDateTHHandicapped">handicapped</th>
																				<th id="tableConflictDateTHDuplicateOptions" style="width: 142px;"></th>
                                                                               
																			</tr>
																		</thead>
																		 <tbody id="tbodyIdDependent">
                                                                              <tr id="dependentTrId">
																			    <input type="hidden" value="" name="staffDependentsID[]" />
																				<td class="p-1"><input type="text" id="staffFamilyName" name="staffDependentsName[]"
																					class="form-control"></td>
																				<td class="p-1"><input type="text" id="staffNameKatakana" name="staffDependentsNamekatakana[]"
																					class="form-control"></td>
																				<td class="p-1"><input type="date" id="staffDependentBirthday" name="staffDependentsBirthday[]"
																					class="form-control"></td>
																				<td class="p-1">
																				<select class="form-control" id="staffDependentGender" name="staffDependentsGender[]" >
																						<option value=""></option>
																						<option id="dependentGenderMale" value="1">Male</option>
																						<option id="dependentGenderFemale" value="2">Female</option>
																				</select></td>
																				<td class="p-1">
																				<select class="form-control" id="staffDependentRelationship" name="staffDependentsRelationship[]">
																						<option value=""></option>
																				...
																				<td class="p-1">
																				<select class="form-control" id="staffClassification" name="staffDependentsClassification[]">
																						<option value=""></option>
																				...
																				<td class="p-1">
																				<select class="form-control" id="staffLivingTogether" name="staffDependentsLivingtogether[]">
																						<option value=""></option>
																						<option id="dependentLivingTogether" value="1">Live together</option>
																						<option id="dependentSeparated" value="2">Separated</option>
																						<option id="dependentSeparatedOverseas" value="2">Separated overseas</option>
																				</select></td>
																				<td class="p-1">
																				<select class="form-control" id="staffHandicapped" name="staffDependentsHandicapped[]">
																						<option value=""></option>
																				...
																				<td >
																				    <button
																						class="btn SuccessColor" style="color:white;" onclick="copyDependentRow(this)">
																						<span id="btnSpanDuplicate"><i class="far fa-clone"></i></span>
																					</button>
																					 <button class="btn btn-danger" onclick="removeDependentRow(this)"><i class="fa fa-trash"></i></button>
																				    <button class="btn btn-danger" onclick="clearDependentRow(this)"><i class="fa fa-eraser"></i></button>
																					</td>
																			</tr>
																		</tbody>
																	</table>
																	...
																	<div class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-0 ContentAlignRC">
																    <button class="btn SuccessColor" onclick="addDependentRow()" id="addDependentRow">Add Row</button>
															       </div>
																</div>
															</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText" id="pageSpanResidentTaxClassification">Resident tax classification</div>
																<div>
																	<select id="staffResidentTaxClassification"
																		class="form-control">
																		<option value="" id="SelectStaffResidentTaxClassification">Select Resident tax classification</option>
																		<option value="1" id="pageSpanNormalCollection">Normal Collection</option>
																		<option value="2" id="pageSpanSpecialCollection">Special Collection</option>
																	</select>
																</div>
															</div>
                                                        ...
                                                        <div class="row pt-3 pb-3">
															<div class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-3 ContentAlignRC">
																<button onclick="checkSocialInsurance()"
																class="btn DefaultButton btn-info TopButtonMinWidth"
											...
											<div class="card SDAccordionCard mb-2">
												...
												<div id="otherInformation" class="collapse"
													...
													<div class="card-body SDAccordionCardBody">
                                                      ...
                                                      <div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3" >
                                                        <div class="DetailsTitleText" id="pageSpanStaffCode">Staff Code</div>
                                                        <div>
                                                            <input type="text" id="staffStaffCode"  class="form-control" disabled>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-6" ></div>
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																...
																<div>
																    <form method="POST" enctype="multipart/form-data" id="fileUploadForm">
														              <input type="file" id="staffFacePhotoFile" class="form-control" onchange="loadFile(event)">
														              <div id="errorStaffFacePhotoFile" class="RequiredStar"></div>
														            </form>
																	<span id="pageSpanHelpFacePhoto"> * This is a
																		face photo to be displayed in the list and resume.
																	</span>
																</div>
															</div>

															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																<div class="DetailsTitleText" id="pageSpanPreview">Face Photo Preview</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	...
																	<button onclick="getAddressOther('staffEmergencyPostalCode','staffEmergencyAddress')"
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	 <Select id="staffEmergencyPrefecture" class="form-control">
                                                                <option value="" id="#pageOption0Prefecture"> Select Prefecture </option>
                                                               <option value="1" data-Prefecture2="北海道" id="#pageOption1Prefecture">Hokkaido</option>
																		<option value="2" data-Prefecture2="青森県" id="#pageOption2Prefecture">Aomori</option>
																		<option value="3" data-Prefecture2="岩手県" id="#pageOption3Prefecture">Iwate</option>
																		<option value="4" data-Prefecture2="宮城県" id="#pageOption4Prefecture">Miyagi</option>
																		<option value="5" data-Prefecture2="秋田県" id="#pageOption5Prefecture">Akita</option>
																		<option value="6" data-Prefecture2="山形県" id="#pageOption6Prefecture">Yamagata</option>
																		<option value="7" data-Prefecture2="福島県" id="#pageOption7Prefecture">Fukushima</option>
																		<option value="8" data-Prefecture2="茨城県" id="#pageOption8Prefecture">Ibaraki</option>
																		<option value="9" data-Prefecture2="栃木県" id="#pageOption9Prefecture">Tochigi</option>
																		<option value="10" data-Prefecture2="群馬県" id="#pageOption10Prefecture">Gunma</option>
																		<option value="11" data-Prefecture2="埼玉県" id="#pageOption11Prefecture">Saitama</option>
																		<option value="12" data-Prefecture2="千葉県" id="#pageOption12Prefecture">Chiba</option>
																		<option value="13" data-Prefecture2="東京都" id="#pageOption13Prefecture">Tokyo</option>
																		<option value="14" data-Prefecture2="神奈川県" id="#pageOption14Prefecture">Kanagawa</option>
																		<option value="15" data-Prefecture2="新潟県" id="#pageOption15Prefecture">Niigata</option>
																		<option value="16" data-Prefecture2="富山県" id="#pageOption16Prefecture">Toyama</option>
																		<option value="17" data-Prefecture2="石川県" id="#pageOption17Prefecture">Ishikawa</option>
																		<option value="18" data-Prefecture2="福井県" id="#pageOption18Prefecture">Fukui</option>
																		<option value="19" data-Prefecture2="山梨県" id="#pageOption19Prefecture">Yamanashi</option>
																		<option value="20" data-Prefecture2="長野県" id="#pageOption20Prefecture">Nagano</option>
																		<option value="21" data-Prefecture2="岐阜県" id="#pageOption21Prefecture">Gifu</option>
																		<option value="22" data-Prefecture2="静岡県" id="#pageOption22Prefecture">Shizuoka</option>
																		<option value="23" data-Prefecture2="愛知県" id="#pageOption23Prefecture">Aichi</option>
																		<option value="24" data-Prefecture2="三重県" id="#pageOption24Prefecture">Mie</option>
																		<option value="25" data-Prefecture2="滋賀県" id="#pageOption25Prefecture">Shiga</option>
																		<option value="26" data-Prefecture2="京都府" id="#pageOption26Prefecture">Kyoto</option>
																		<option value="27" data-Prefecture2="大阪府" id="#pageOption27Prefecture">Osaka</option>
																		<option value="28" data-Prefecture2="兵庫県" id="#pageOption28Prefecture">Hyogo</option>
																		<option value="29" data-Prefecture2="奈良県" id="#pageOption29Prefecture">Nara</option>
																		<option value="30" data-Prefecture2="和歌山県" id="#pageOption30Prefecture">Wakayama</option>
																		<option value="31" data-Prefecture2="鳥取県" id="#pageOption31Prefecture">Tottori</option>
																		<option value="32" data-Prefecture2="島根県" id="#pageOption32Prefecture">Shimane</option>
																		<option value="33" data-Prefecture2="岡山県" id="#pageOption33Prefecture">Okayama</option>
																		<option value="34" data-Prefecture2="広島県" id="#pageOption34Prefecture">Hiroshima</option>
																		<option value="35" data-Prefecture2="山口県" id="#pageOption35Prefecture">Yamaguchi</option>
																		<option value="36" data-Prefecture2="徳島県" id="#pageOption36Prefecture">Tokushima</option>
																		<option value="37" data-Prefecture2="香川県" id="#pageOption37Prefecture">Kagawa</option>
																		<option value="38" data-Prefecture2="愛媛県" id="#pageOption38Prefecture">Ehime</option>
																		<option value="39" data-Prefecture2="高知県" id="#pageOption39Prefecture">Kochi</option>
																		<option value="40" data-Prefecture2="福岡県" id="#pageOption40Prefecture">Fukuoka</option>
																		<option value="41" data-Prefecture2="佐賀県" id="#pageOption41Prefecture">Saga</option>
																		<option value="42" data-Prefecture2="長崎県" id="#pageOption42Prefecture">Nagasaki</option>
																		<option value="43" data-Prefecture2="熊本県" id="#pageOption43Prefecture">Kumamoto</option>
																		<option value="44" data-Prefecture2="大分県" id="#pageOption44Prefecture">Oita</option>
																		<option value="45" data-Prefecture2="宮崎県" id="#pageOption45Prefecture">Miyazaki</option>
																		<option value="46" data-Prefecture2="鹿児島県" id="#pageOption46Prefecture">Kagoshima</option>
																		<option value="47" data-Prefecture2="沖縄県" id="#pageOption47Prefecture">Okinawa</option>                                                      
                                                             </Select>
																</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																 <div class="DetailsTitleText">
		                                                        <span class="DetailsTitleText" id="pageSpanEmergencyContactPhoneNumber">Emergency Contact Phone Number</span>
		                                                        <span class="RequiredStar">*</span>
		                                                        </div>
																<div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3" >
		                                                        <div class="DetailsTitleText" id="pageSpanStaffStaff">In Charge Staff</div>
		                                                        <div><input type="text" id="staffStaffStaff" class="form-control"></div>
	                                                   		</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-4 pl-3 pr-3">
																...
																<div>
																	<textarea id="staffInformationUpdate"
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
		                                                        <span class="DetailsTitleText" id="pageSpanValidClassification">Valid Classification </span>
		                                                        <span class="RequiredStar">*</span>
		                                                        </div>
																<div>
																	<select id="staffValidClassification" class="form-control">
			                                                              <option id="option0ValidClassification" value="" selected>Select Valid Classification</option>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText" id="pageSpanDateofleavingthecompany">Date of leaving the company</div>
																<div>
																	<input type="date" class="form-control" id="staffDateofleavingthecompany">
																</div>
															</div>
														...
														<div class="row pt-3 pb-3">
															<div
																...
																<button onclick="checkOther()"
																	class="btn DefaultButton btn-info TopButtonMinWidth"
																	id="buttonSaveOtherInformation">Save Other Information</button>
															</div>
														</div>						
													</div>
												</div>
	...
	<script>
			...
			$.ajax({
				...
				success : function(result, status, request) {
					if (result.status == 200) {
						document.getElementById("buttonSaveStaffInformation").disabled = true;
						localStorage.setItem("saveUuid", result.data3.uuid);
						saveUuid = localStorage.getItem('uuid');
						localStorage.setItem("saveStaffCode",result.data3.staffCode);
						saveStaffCode = localStorage.getItem('saveStaffCode');
			...
			$.ajax({
				...
				success : function(result, status, request) {
					if (result.status == 202) {
						document.getElementById("buttonSaveTransportationInformation").disabled = true;
		...
		function saveResumeInfo() 
		{
	         ...
	         for(var i = 0; i < educationalIDArray.length; i++)
	     	{
	            ...
	            var tempEducation ={"dateFrom":educationDateFrom,
	     	...
	     	for(var i = 0; i < workHistoryCredentialsID.length; i++)
	     	{
	     		 ...
	     		 var CredentialscompanyName = workExperienceTypeCredentials[i].value !="" ? workExperienceTypeCredentials[i].value.trim() : null;
	     		 var CredentialsexperienceType = workExperienceTypeCredentials[i].value !="" ? workExperienceTypeCredentials[i].value.trim() : null;
	     		 
	     		 var tempWork ={"dateFrom":CredentialsworkDateFrom,
	     	 ...
	     	 for(var i = 0; i < licenseQualificationIDArray.length; i++)
	     	 {
	             ...
	             var tempLicence = {"dateFrom":licenceDateFrom,
			...
			$.ajax({
				...
				success : function(result, status, request) {
					if (result.status == 202) {
						document.getElementById("buttonSaveResumeInformation").disabled = true;	
		...
		function savePayrollInfo()
		{
			...
			$.ajax({
				...
				success : function(result, status, request) {
					if (result.status == 202) {
						document.getElementById("buttonSavePayrollInformation").disabled = true;	
	    ...
	    function saveSocialInfo()
	    {
			...
			$.ajax({
				...
				success : function(result, status, request) {
					if (result.status == 202) {
						document.getElementById("buttonSaveSocialInformation").disabled = true;
		...
		function saveLoginInfo()
		{
			...
			var conformEmail = document.getElementById("pageSpanEmailAddressConfirm").value;
			var password = 123;
			...
			$.ajax({
				...
				success : function(result, status, request) {
					if (result.status == 200) {
						document.getElementById("buttonSaveLoginInformation").disabled = true;
		...
		function saveOtherInfo()
		{
			...
			var postalCode = document.getElementById("staffEmergencyPostalCode").value;
			...
			$.ajax({
				...
				success : function(result, status, request) {
					if (result.status == 200) {
						document.getElementById("buttonSaveOtherInformation").disabled = true;
