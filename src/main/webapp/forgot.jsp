...
<head>
    ...
    <title id="pageSpanForget">Forgot</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="p-4">
                        ...
                        <h1 class="mb-3 text-center text-18" id="pageSpanForgetPassword">Forgot Password</h1>
...
//const serverHTTP = "https://api.dan-system.jp/";
  ...
  form.addEventListener('submit', e => {
   e.preventDefault();
    ...
    $.ajax({
        url: serverHTTP +'users/ForgotPasswordMail',
        method: 'POST',
        ...
        dataType: 'json',
         ...
         if(result.status==200)
        	 ...
        	 { 
        		 showLoginMessage("alert alert-success","N1278");
       	     }else{
       	    	 showLoginMessage("alert alert-danger","N1277");
        	 }  
        	 }else{
        		 showLoginMessage("alert alert-danger","N1277");
        	 }
...
{
	document.getElementById("messsageDiv").innerHTML='<div class="'+type+'" role="alert pt-0 pb-0 mt-0 mb-0"> <strong>'+message+'</strong><button onclick="hideLoginMessage()" type="button" class="close" aria-label="Close">&times;</button></div>';
