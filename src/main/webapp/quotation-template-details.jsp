...
<head>
    ...
    <title id="pageTitleQuotationTemplateDetails"> Quotation Template Details  </title>
...
<body class="text-left" >
 <%@ include file="common/CacheControl.jsp"%>
                            ...
                            <div class="card-body p-0" >
                              <div class="row pt-4 mt-2 ml-2">
                                <div class="col-sm-12 TopActionButDiv mr-4 pr-4 ">   
                                    ...
                                    <div class="col-md-8 " >
                                        <h1> <i class="fa fa-users text-30" role="generic" ></i><span id="pageSpanHeadingQuotationDetails">  Quotation Template Details </span></h1>
                                       
                                        <p class="pb-0 mb-0" id="pageSpanSubHeadingQuotationDetails">You can modify the quotation template. </p>
                                    </div>
                                    <div class="col-md-4  ">
                                       ...
                                       <div class="btn-group">
                                                ...
                                                <button class="dropdown-item" id="quotationTempDelete" href="#"><span id="buttonValueSpanQuotationTempDelete">Delete Quotation Template</span></button>
                                                </div>
                                               </div>
                                            </div>
                                        </div>
                                                 ...
                                                 <div class="col-sm-12 col-md-3 col-lg-3 pl-3 pr-3" >
                                                          ...
                                                          <table class="display table table-striped table-bordered mb-0" id="QuotationDetails_table" style="width:100%">
                                                              <thead id="quotationDetailsTaxableTheadId">
                                                                  <tr>
                                                                     ...
                                                                     <th id="tableQuotationDetailsTHMajorItems" style="width:10%"> Major Items</th>
                                                              ...
                                                              <tfoot id="quotationDetailsTaxableTfootId">
                                                                <tr>
                                                                     ...
                                                                     <th colspan="1"  class="amount-content-color" >¥  <span id="tableQuotationDetailsSubtotalTaxableVal"style="border-left: none;border-right: none;" ></span></th> 
                                                          ...
                                                          <table class="display table table-striped table-bordered mt-0" id="QuotationDetailsNonTaxable_table" style="width:100%;">
                                                              <thead id="quotationDetailsNonTaxableTheadId">
                                                                  <tr>
                                                                    <th id="tableQuotationDetailsNonTaxableDetailsTHNo"> No</th>
                                                                     <th id="tableQuotationDetailsNonTaxableDetailsTHMajorItems" style="width:10%"> Major Items</th>
                                                             ...
                                                             <tfoot id="quotationDetailsTotalfootId">
                                                                <tr>
                                                                     ...
                                                                     <th colspan="2"  style="border-right: none"> </th>
                                                                     <th colspan="1" class="amount-content-color" >¥ <span id="tableQuotationDetailsFullTotalVal"style="border-left: none;border-right: none;"></span> </th> 
                                                                     <th colspan="1"  style="border-right: none;border-left: none;"> </th> 
                                                              ...
                                                              <tfoot id="quotationDetailsNonTaxableTfootId">
                                                                <tr>
                                                                     ...
                                                                     <th colspan="2"  style="border-right: none"> </th>
                                                                     <th colspan="1" class="amount-content-color"   >¥ <span id="tableQuotationDetailsSubtotalNonTaxableVal"style="border-left: none;border-right: none;"></span></th> 
                                                                     <th colspan="1"  style="border-right: none;border-left: none;"> </th> 
                                                    ...
                                                    <div class="row pt-3 pb-3">
                                                       ...
                                                       <div class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-0 ContentAlignRC" >
                                                            <button class="btn btn-info" id="buttonEditQuoteDetails">Update Quotation Template</button>
                                                        </div> 
    ...
    <script src="./dist-assets/js/quotation-template-detatils-validate.js"></script>
    <script>
...
function  getQuotationTempInfo(result)
	...
	function calTaxableUnitPrice(node)
 {
		...
		if(unitPriceReturn == true && quantityReturn == true){  // Uvindu.......................
 ...
 function editQuotationTempInfo(){
	...
	$("#quotationTempDelete").click(function( event ) { 
		...
		let dataSet = '{"quotationTemplate": {"id": '+templateID+'}}';
    	   ...
    	   $.ajax({
             ...
             url: serverHTTP +'Quotation/DeleteQuotationTempInfo',
             method: 'POST',
             contentType: 'application/json',
             data: dataSet,
             dataType: 'json',
              ...
              if(result.status==200)
             	 {
              	showMessage('success',"N1209");
              	setTimeout(function(){
              		window.location.href = "quotation-template.jsp"; 
              		}, 3600);

             	 }
              else
              {
              	showMessage('error',"N1210");
             		// showMessage("Sorry Data Loding Error");
             	 }
              },
              error: function(error) {
