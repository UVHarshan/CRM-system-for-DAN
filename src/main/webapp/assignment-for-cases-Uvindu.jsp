...
<title id="pageTitleAssignmentForImplementationCase">Assignment
	For Implementation Case</title>
...
<body class="text-left">
												...
												<div id="implementationInformation" class="collapse show"
													...
													<div class="card-body SDAccordionCardBody">
														...
														<div class="row pb-4">
															...
															<div id="" style="color: red;">aaaaaaaa</div>
															...
															<div class="m-3 pt-2">
																...
																<div class="table-responsive">
																	<table
																		...
																		id="assigned_staff_table" style="width: 100%">
																		<thead>
																			<tr>
																				...
																				<th class="TableTHMinWidth text-center"
																					style="background: rgb(208, 226, 241); color: #647a8e;"
																					id="tableSearchTHOperation">Operation</th>
																			</tr>
																		</thead>
																		<tbody id="tbodyId">
																			<!--   <tr>
													...
													<div class="card-body SDAccordionCardBody">
														<div class="row pb-4">
															...
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="time" disabled id="StationScheduledStartTime" class="form-control" maxlength="255">
																</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="time" disabled id="StationScheduledEndTime" class="form-control" maxlength="255">
																</div>
		...
		<div class="modal-dialog modal-lg modal-wider" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Search Staff
						and Assign</h5>
										...
										<div class="card-body">
											...
											<form id="searchForm" method="post">
												<div class="row">
													...
													<div class="col-lg-4 col-md-6 pl-2 pr-2">
														<label for="staffGender" id="staffGender"> Gender</label>
														<div>
															<div class="input-group ">
																<div class="input-group-prepend">
																	<div class="input-group-text bg">
																...
																<Select id="gender" class="form-control">
																	<option value="" id="">Select Gender</option>
													...
													<div class="col-lg-4 col-md-6 pl-2 pr-2">
														...
														<div class="input-group ">
															...
															<Select id="attributeStaff" name="attributeW"
																class="form-control" role="combobox">
														...
														<div>
															<div class="input-group ">
																...
																<Select id="salaryPaymentForm" class="form-control">
																	<option value="" id="">Select Salary Payment
																		Form</option>
	...
	<script>
		...
		function runSearch() {
			...
			templateNameReqNode['belong'] = document.getElementById("belongs").value
					.trim() != "" ? document.getElementById("belongs").value
					.trim() : null;
			templateNameReqNode['name'] = document.getElementById("staffName").value
					.trim() != "" ? document.getElementById("staffName").value
					.trim() : null;
			templateNameReqNode['gender'] = document.getElementById("gender").value != "" ? parseInt(document
					.getElementById("gender").value)
					: null;
			templateNameReqNode['prefecture'] = document
					.getElementById("prefectures").value != "" ? parseInt(document
					.getElementById("prefectures").value)
					: null;
			templateNameReqNode['experienceType'] = document
					.getElementById("experience").value.trim() != "" ? document
					.getElementById("experience").value.trim() : null;
			templateNameReqNode['staffInCharge'] = document
					.getElementById("inChargeStaff").value.trim() != "" ? document
					.getElementById("inChargeStaff").value.trim()
					: null;
			templateNameReqNode['addressLine'] = document
					.getElementById("address").value.trim() != "" ? document
					.getElementById("address").value.trim() : null;
			templateNameReqNode['attribute'] = document
					.getElementById("attributeStaff").value != "" ? parseInt(document
					.getElementById("attributeStaff").value) : null;					
					
			templateNameReqNode['dobTo'] = document
					.getElementById("dateOfBirthTo").value != "" ? document
					.getElementById("dateOfBirthTo").value : null;
			templateNameReqNode['dobFrom'] = document
					.getElementById("dateOfBirthFrom").value != "" ? document
					.getElementById("dateOfBirthFrom").value : null;
			templateNameReqNode['salaryPaymentForm'] = document
					.getElementById("salaryPaymentForm").value != "" ? parseInt(document
					.getElementById("salaryPaymentForm").value)
					: null;
			templateNameReqNode['qualification'] = document
					.getElementById("qualification").value != "" ? parseInt(document
					.getElementById("qualification").value)
					: null;

			templateNameReqNode['dispatchClassification1'] = dispatchClassification == 1 ? 1
					: null;
			templateNameReqNode['dispatchClassification2'] = dispatchClassification == 2 ? 1
					: null;
			templateNameReqNode['dispatchClassification3'] = dispatchClassification == 3 ? 1
					: null;
			templateNameReqNode['dispatchClassification4'] = dispatchClassification == 4 ? 1
					: null;
			...
			// templateNameReqNode['nameKatakana'] =  null ;
			// templateNameReqNode['mobile'] =  null ;
			// templateNameReqNode['email'] =  null ;
			// templateNameReqNode['staffCode'] =  null ;
			...
			// templateNameReqNode['validClassification'] =  null ; 
			// templateNameReqNode['unitPriceFrom'] = null ;
			// templateNameReqNode['unitPriceTo'] =  null ;

			$.ajax({
						beforeSend : function(request) {
							document.getElementById("loaderNotify").style.display = "";
							console.log("loaderline1");
							request.setRequestHeader("GUID", GUID);
						},
		...
		function TemporarilyAddStaff() {
			...
			const tableCheckNode = document.querySelectorAll('input[name="implementationDuplicateSelection[]"]:checked');
			if (tableCheckNode.length == 0) {
				showSystemMessage('info', "N0000");
			}else if(tableCheckNode.length  > requiredNoStaff){
				showMessage('info', "N1267");				
			}else {
				let dataPassNode = {};
		...
		function checkNumberOfStaff(){
			...
			var assignedNo = $('#assigned_staff_table tr').length - 1;
