...
MonthlyIncomeTaxes = [
	["pageTitleMonthlyIncomeTaxes", "月次所得税"],
	["pageTitleMonthlyIncomeTaxesDetails", "月次所得税の詳細"],
	["pageTitleMonthlyIncomeTaxesRegistration", "月次所得税登録"],
	["pageSpanHeadingIncomeMonthlyRegistration", "月次所得税登録"],
	["pageSpanHeadingMonthlyIncomeTaxDetails", "源泉徴収月額一覧"],
	["pageSpanSubHeadingMonthlyIncomeTaxDetails", "源泉徴収月額情報を一覧で確認できます。"],
	["buttonSpanReturn", "戻る"],
	["accordionDivIncometaxmonthlyinformation", "源泉徴収月額情報"],
	["pageSpanyear", "年度"],
	...
	["pageSpanHeadingMonthlyIncomeTaxList", "月次源泉徴収リスト"],
	["pageSpanSubHeadingMonthlyIncomeTaxList", "毎月の源泉徴収情報を一覧で確認することができます。"],
	["buttonSpanAddMonthlyIncomeTaxes", "毎月の源泉徴収を追加"],
	["pageSpanSearch", " 検索"],
	["pageLabelYear", "年"],
	["selectOptionyearYear", "年を選択"],
	["clearAllBtn", "全て消去"],
	["searchBtn", "検索"],
	["pageSpanSearchIncomeTaxDetails", "検索結果"],
	["MonthlyIncomeTHInstep", "甲"],
	["MonthlyIncomeTHb", "乙"],
	["MonthlyIncomeTHYear", "年度"],
	["MonthlyIncomeTHThreshold", "しきい値"],
	["MonthlyIncomeTHTaxDependent0", "税額 扶養0"],
	["MonthlyIncomeTHTaxDependent1", "税額 扶養1"],
	["MonthlyIncomeTHTaxDependent2", "税額 扶養2"],
	["MonthlyIncomeTHTaxDependent3", "税額 扶養3"],
	["MonthlyIncomeTHTaxDependent4", "税額 扶養4"],
	["MonthlyIncomeTHTaxDependent5", "税額 扶養5"],
	["MonthlyIncomeTHTaxDependent6", "税額 扶養6"],
	["MonthlyIncomeTHTaxDependent7", "税額 扶養7"],
	["MonthlyIncomeTHTaxRate1", "税率"],
	["MonthlyIncomeTHTaxAmount", "税額"],
	["MonthlyIncomeTHTaxRate2", "税率"],
	["pageSpanHeadingIncomeMonthlyDetails", "月次源泉徴収の詳細"],
	["pageSpanSubHeadingIncomeTaxMonthlyDetails", "毎月の源泉徴収の金額の詳細を確認することができます。"],
	["pageSpantaxrate", "税率"],
	["pageSpanremarks", "備考"],
	["buttonTaxDailySaveInformation", "更新情報"],
	["buttonTaxSaveMonthlyIncomeTaxDetail", "毎月の所得税の明細を保存"],
	          
];


MonthlyIncomeTaxesErrorArray ={"E2240":"空であってはならない",
						   "E2253":"数字のみであること",	
