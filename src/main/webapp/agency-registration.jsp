...
<title id="pageTitleAgencyRegistration">Agency Registration</title>
<link
...
<body class="text-left">
									...
									<div class="col-md-8 ">
										<h1>
											<i class="fa fa-users text-30" role="generic"></i><span
												id="pageSpanHeadingAgencyRegistration"> Agency Registration</span>
										</h1>

										<p class="pb-0 mb-0" id="pageSpanSubHeadingAgencyRegistration">You can register as an agency</p>
									</div>
									<div class="col-md-4">
									<div class="row pt-0 ">
                                                          ...
                                                          <button class="btn SuccessColor ml-1">Adress Search</button>
															...
															<div
																...
																<button
																	...
																	id="buttonRegisterAgencyInformation">Register</button>
															</div>
														</div>
	...
	<script src="./dist-assets/js/agency-register-validate.js"></script>
