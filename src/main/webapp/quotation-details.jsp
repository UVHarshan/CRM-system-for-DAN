									...
									<div class="col-md-8  ">
										<div class="row pt-0  pr-2">
											<div class="col-sm-12 pr-4 TopButDiv">
												<button class="DefaultButton btn btn-info TopButtonMinWidth "
													onclick="quotationDownload();" type="button" aria-haspopup="true"
													aria-expanded="false">
													<span id="buttonSpanQuotationDownload">Quotation Download</span>
												</button>
													...
													<div class="dropdown-menu" x-placement="bottom-start">
														<a class="dropdown-item" onclick="copyQuotation();"><span
															...
															id="buttonValueSpanCustomerProposalCreation">Proposal
																Creation</span></a> <a class="dropdown-item" onclick="makeInvoiceByQuotation();"><span
															id="buttonValueSpanCustomerInvoiceCreation">Invoice
																Creation</span></a>
													</div>
												</div>
												<button
													class="DefaultButton btn btn-info TopButtonMinWidth mr-0"
    ...
    for(i=0;i<taxableItemsCount;i++)
    {
    	...
    	subTotalTaxable = subTotalTaxable + itemAmount;
    	 ...
    	 let newRow = '<tr id="quotationDetailsTaxableTrId">'+
						...
						'</td>'+
						'<td>'+
						'<button class="btn btn-danger mr-1 mb-1" onclick="removeTaxableRow(this)"><i class="fa fa-trash"></i></button>'+
...
// if(nonTaxableItemsCount>0)
 ...
 function calculateTotal()
 {
	...
	function makeInvoiceByQuotation()
	{
		...
		localStorage.setItem("invoiceQuotationId", searchid);	
		localStorage.setItem("invoiceCustomerID", customerID);	
