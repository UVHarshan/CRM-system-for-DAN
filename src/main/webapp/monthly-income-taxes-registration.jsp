...
<title id="pageTitleMonthlyIncomeTaxesRegistration">Monthly Income Taxes Registration</title>
<link
...
<body class="text-left">
									...
									<div class="col-md-6 ">
										<h1>
											<i class="fa fa-calculator text-30" role="generic"></i><span
												id="pageSpanHeadingIncomeMonthlyRegistration"> Monthly Income Tax Registration </span>
										</h1>

										<p class="pb-0 mb-0" id="pageSpanSubHeadingIncomeTaxMonthlyDetails">You can add the details of the monthly  income tax amount.</p>
									</div>
									<div class="col-md-6">
													...
													<button class="btn btn-link2 collapsed SDAccordion"
														...
														<div class="row">
															<div class="col-10" style="text-align: left;"
																id="accordionDivIncometaxmonthlyinformation">Monthly Income Tax Information</div>
								...
								<div class="col-lg-12 col-xl-12 ">
									<div id="accordion" class="m-3 ">
										<div class="card SDAccordionCard mb-2">
											...
											<div id="declarationofdependentdeduction" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
												<div class="card-body SDAccordionCardBody">
													<div class="row pb-4">
														<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
															<div class="DetailsTitleText">
																<span id="pageSpanTaxamountdependents0">Tax amount (0 dependents)</span> <span class="RequiredStar">*</span>
															</div>
															<div>
														...
														<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
															<div class="DetailsTitleText">
																<span id="pageSpantaxrate">Tax Rate </span>
															</div>
															<div>
													...
													<div class="row pb-4">
														...
														<div
															...
															<button
																...
																id="buttonTaxSaveMonthlyIncomeTaxDetail">Save Monthly Income Tax Details</button>
														</div>
	...
	<script src="./dist-assets/js/monthly-income-taxes-registration-validate.js"></script>
    ...
    function saveMonthlyIncomeTax()
    {
    	  var dataNode = {};
    	  dataNode['id'] ="";
    	  dataNode['uuid'] =uuid;
    	  dataNode['taxtimetype'] ="2";
    	  ...
    	  dataNode['typeA_Rate'] = document.getElementById("taxRate").value.trim()!="" ? document.getElementById("taxRate").value.trim() : null ;
    	  ...
    	  $.ajax({
              ...
              dataType: 'json',
               ...
               if(result.status==200)
              	 {
            	   document.getElementById("buttonTaxSaveMonthlyIncomeTaxDetail").disabled = true;
