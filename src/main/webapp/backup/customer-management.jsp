                        ...
                        <div id="bodyMainCard" class="card mb-4" >
                            <div  class="card-body p-0"   >
                              <div class="row pt-4 mt-2 ml-2">
                                    <div class="col-md-4 " >
                                        <h1 > <i class="fa fa-users text-30" role="generic"></i><span id="pageSpanHeadingCustomer"> Customer List</span> </h1>
                                    </div>
                                    <div class="col-md-8  pt-0 pr-4 TopButDiv">
                                        <a href="customer-registration.jsp"><button class="DefaultButton btn btn-info TopButtonMinWidth mr-2" role='button'><i class="fa fa-plus mr-2 text-20 cursor-pointer" role="generic" ></i><span id="buttonSpanCustomerReg">Customer Registration</span></button> </a>
                                        <a href="customer-batch-registration.jsp"><button class="DefaultButton btn btn-info TopButtonMinWidth mr-2" role='button'><i class="fa fa-upload mr-2 text-20 cursor-pointer" role="generic" ></i><span id="buttonSpanImportCustomerData">Import Existing Customer Data</span></button></a>
                                        <button class="DefaultButton btn btn-info TopButtonMinWidth mr-2" role='button' id="btnOutputCustomerListCSV" ><i class="fa fa-table mr-2 text-20 cursor-pointer" role="generic" ></i><span id="buttonSpanCustomerListCSV">Output Customer List CSV</span></button>
                                    </div>
                              </div>
                             ...
                             <div class="row">
                                        ...
                                        <div class="card-body" >
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-6 pl-2 pr-2">
                                                        <label for="givenNames" id="pageLabelCompanyName">Company Name</label>
                                                        <div class="input-group ">
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text bg"><i class="far fa-building"></i></div>
                                                            </div>
                                                            <input id="companyNames" name="companyNames" placeholder="Enter Company Name" class="form-control" role="textbox">
                                                            
                                                        </div>
                                                        <div id="errorGivenName" style="color:red;"></div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6 pl-2 pr-2">
                                                        <label for="nameKatakana" id="pageLabelCompanyNameKatakana">Company Name Katakana</label>
                                                        <div class="input-group ">
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text bg"><i class="far fa-building"></i></div>
                                                            </div>
                                                        <input id="companyNameKatakana" name="companyNameKatakana" placeholder="Enter Company Name Katakana" class="form-control" role="textbox">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6 pl-2 pr-2">
                                                        ...
                                                        <input id="companyBelonging" name="companyBelonging" placeholder="Enter Belonging" class="form-control" role="textbox">
                                                        </div>
                                                        <div id="errorStaffCode" style="color:red;"></div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6 pl-2 pr-2">
                                                        <label for="staffCode" id="pageLabelCustomerCode">Customer Code</label>
                                                        <div class="input-group"  >
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text bg"><i class="far fa-user-circle"></i></div>
                                                            </div>
                                                        <input id="customerCode" name="customerCode" placeholder="Enter Customer Code" class="form-control" role="textbox">
                                                        </div>
                                                    ...
                                                    <div class="col-lg-4 col-md-6 pl-2 pr-2">
                                                        <label for="mailAddress" id="pageLabelMailAddress">Email Address</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text bg"><i class="far fa-envelope"></i></div>
                                                            </div>
                                                        <input id="mailAddress" name="mailAddress" placeholder="Enter Email Address"  class="form-control" role="textbox">
                                                        </div>
                                                    ...
                                                    <div class="col-lg-4 col-md-6 pl-2 pr-2">
                                                        <label for="belongs" id="pageLabelPostalcode">Postal code</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text bg"><i class="fa fa-bold"></i></div>
                                                            </div>
                                                        <input id="postalCode" name="postalCode" placeholder="Enter Postal code" class="form-control" role="textbox">
                                                        </div>
                                                    ...
                                                    <div class="col-lg-4 col-md-6 pl-2 pr-2">
                                                        ...
                                                        <input id="companyAddress" name="companyAddress" placeholder="Enter Company Address" class="form-control" role="textbox">
                                                        </div>
                                                    </div>
                                                    
                                                    <div class="col-lg-4 col-md-6 pl-2 pr-2">
                                                        <label for="streetAddress" id="pageOrganizationName">Organization Name</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text bg "><i class="far fa-building"></i></div>
                                                            </div>
                                                        <input id="companyOrganizationName" name="companyOrganizationName" placeholder="Enter Organization Name" class="form-control" role="textbox">
                                                        </div>
                                                    </div>
                                                     <div class="col-lg-4 col-md-6 pl-2 pr-2">
                                                        <label for="streetAddress" id="pageLabelRepresentativeName">Customer Representative Name</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text bg "><i class="far fa-user"></i></div>
                                                            </div>
                                                        <input id="companyRepresentativeName" name="companyRepresentativeName" placeholder="Enter Customer Representative Name" class="form-control" role="textbox">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6 pl-2 pr-2">
                                                        <label for="streetAddress" id="pageLabelRepresentativeNameKatakana">Customer Representative Name Katakana</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text bg "><i class="far fa-user"></i></div>
                                                            </div>
                                                        <input id="companyRepresentativeNameKatakana" name="companyRepresentativeNameKatakana" placeholder="Enter Customer Representative Name Katakana" class="form-control" role="textbox">
                                                        </div>
                                                    </div>           
                                                    <div class="col-lg-4 col-md-6 pl-2 pr-2">
                                                        ...
                                                        <select id="companyManager" name="companyManager" class="form-control" role="combobox">
                                                            <option value=""  id="selectOptionSelectCompanyManager">Select Manager</option>
                                                            <option value="1" id="selectOptionSelectCompanyManagerA">Company Manager A</option>
                                                            <option value="2" id="selectOptionSelectCompanyManagerB">Company Manager B</option>
                                                            <option value="3" id="selectOptionSelectCompanyManagerC">Company Manager C</option>
                                                            <option value="4" id="selectOptionSelectCompanyManagerD">Company Manager D</option>
                                                            <option value="5" id="selectOptionSelectCompanyManagerE">Company Manager E</option>
                                                        </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6 pl-2 pr-2">
                                                        <label for="registrationDevision" id="pageLabelCustomerRank">Rank</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                        ...
                                                        <select id="registrationDevision" name="registrationDevision" class="form-control" role="combobox">
                                                            <option value=""  id="selectOptionSelectRank">Select Rank</option>
                                           ...
                                           <div class="row pt-1 ContentRight"  >
                                                        ...
                                                        <button id="searchBtn" class="btn btn-info SearchButton-2   ml-0 mr-2" role="button">Search</button>
                                ...
                                <div class="col-lg-2 col-md-12 col-sm-12  p-0 m-0">
                                  ...
                                  <!-- <div class="row" style="background-color: blueviolet; ">  -->
                                    ...
                                    <div class="card card-icon-bg card-icon-bg-primary o-hidden  Color-1 cardBodyDiv"  >
                                        <div class="card-body" style="margin:auto">
                                            <div class="row"  style="text-align: center;">
                                                <div class="col-12 p-0 " id="pageCardDivTotalCustomers" >Total Number of Customers</div>
                                    ...
                                    <div class="card card-icon-bg card-icon-bg-primary o-hidden  Color-2 cardBodyDiv"  >
                                        <div class="card-body" style="margin:auto">
                                            <div class="row"  style="text-align: center;">
                                                <div class="col-12 p-0 " id="pageCardDivTotalActiveCustomers" >Total Active Customers</div>
                                    ...
                                    <div class="card card-icon-bg card-icon-bg-primary o-hidden  Color-3 cardBodyDiv"  >
                                        <div class="card-body" style="margin:auto">
                                            <div class="row"  style="text-align: center;">
                                                <div class="col-12 p-0 " id="pageCardDivTotalAvailableCustomers">Total Available Customers</div>
                                    ...
                                    <div class="card card-icon-bg card-icon-bg-primary o-hidden  Color-4 cardBodyDiv"  >
                                        <div class="card-body" style="margin:auto">
                                            <div class="row"  style="text-align: center;">
                                                <div class="col-12 p-0 " id="pageCardDivTotalPendingCustomers">Total Pending Customers</div>
                              ...
                              <div class="row">
                                  <div class="col-lg-12 col-xl-12 ">
                                    ...
                                    <div class="card m-3">
                                        <div class="card-body" >
                                            <div class="card-title"><i class="i-File-Clipboard-File--Text cursor-pointer" role="generic"></i><span id="pageSpanSearchCustomerDetails"> Search Customer Details</span> </div>
                                                ...
                                                <table class="display table table-striped table-bordered hover" id="search_table" style="width:100%">
                                                    <thead>
                                                        ...
                                                        <tr class="thClass">
                                                            ...
                                                            <th style="background: rgb(245 249 253);color: #647a8e; text-align: center; min-width:50px;" id="tableSearchStaffTHNo">No</th>
                                                            <th style="background: rgb(245 249 253);color: #647a8e; text-align: center;" id="tableSearchStaffTHChoice">Choice</th>
                                                            <th class="color-1" style="background: rgb(208 226 241);color: #647a8e; text-align: center; min-width:50px;" id="tableSearchCustomerTHCustomerCode">Customer Code</th>
                                                            <th class="TableTHMinWidth text-center" style="background: rgb(208 226 241);color: #647a8e; text-align:"id="tableSearchCustomerTHTel" >Tel/Email</th>
                                                            <th class="color-1" style="background: rgb(208 226 241); color: #647a8e; text-align: center; min-width:100px;" id="tableSearchCustomerTHDispatchClassification">Dispatch Classification</th>
                                                            <th class="TableTHMinWidth text-center" style="background: #a0dade;color: #647a8e;text-align: center;" id="tableSearchCustomerTHAddress">Address</th>
                                                            <th class="TableTHMinWidth-2 text-center" style="background: #a0dade;color: #647a8e;text-align: center;" id="tableSearchCustomerTHOrganizationName">Organization Name</th>
                                                            <th class="TableTHMinWidth-2 text-center" style="background: rgb(208 226 241);color: #647a8e;text-align:" id="tableSearchCustomerTHCustomerRepresentative">Customer Representative Name</th>
                                                            <th class="TableTHMinWidth text-center" style="background: rgb(208 226 241);color: #647a8e;text-align: center;" id="tableSearchCustomerTHManager">Manager</th>
                                                            <th class="TableTHMinWidth text-center" style="background: rgb(208 226 241);color: #647a8e;text-align: center;" id="tableSearchCustomerTHRank">Rank</th>
                                           ...
                                           <div class="row ">
                                            <div class="col-sm-6 col-md-6 col-lg-6 TopButLCDiv">
                                              ...
                                              <div class="col-sm-6 col-md-6 col-lg-6 TopButDiv">
                                                  <button id="batchDeletionBtn" class="btn btn-danger DefaultButton mr-3" role="button" onclick="batchDelete();"><span id="buttonSpanBatchDeletion">Batch Deletion</span></button>
                                              </div>
                                           </div>  
                                        </div>
                                    </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center">
                                ...
                                <h4 id="modalDoYouWantDelete">Do You Really Want to Delete this Records?</h4>
                                <h4 id="modalProcesCannotBeUndone">This Process Cannot be Undone.</h4>
                                <br>
    ...
    <script>
        ...
        function showSearchResult(result,request)
        {
        	 ...
        	 for(i=0;i<result.data.length;i++){
        		 ...
        		 accountManager = managerAray[result.data[i].accountManager] != "" ? managerAray[result.data[i].accountManager]: ""; 
        		 
        		 rankValue = rankArray[result.data[i].rank] != "" ? rankArray[result.data[i].rank]: "";
        		...
        		let newRow=' <tr>'+
                             ...
                             '</label>'+
                    '</td>'+
                    '<td style="background: rgb(245 249 253);color: #647a8e;">'+result.data[i].customerCode+'</td>'+
                    '<td style="background: rgb(245 249 253);color: #647a8e;">'+result.data[i].telCompany+' , '+result.data[i].email+'</td>'+
                    ...
                    '<td >'+result.data[i].organizationName+'</td>'+
                    '<td style="background: rgb(245 249 253);color: #647a8e;">'+result.data[i].customerRepresentativeName+'</td>'+
                    '<td style="background: rgb(245 249 253);color: #647a8e;">'+accountManager+'</td>'+
                    ...
                    '<td style="background: rgb(255 255 255);color: #647a8e;">'+
                        ...
                        '<button class="btn ScheduleButton ml-1" onclick="makeQuotation(\''+result.data[i].id+'\')" title="Make a Quotation" role="button" id="tableButtonDetails_3___"><i class="fa fa-file-alt"></i></button>'+
                     '</td>'+
                '</tr>' ;           
