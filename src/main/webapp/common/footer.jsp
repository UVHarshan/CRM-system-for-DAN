...
<script src="./dist-assets/js/plugins/jquery-3.3.1.min.js"></script>
 ...
 function confirmLogout()
 {
	 ...
	 titleText = notificationArray["E1021"];  // N0006
 ...
 // Dealing with the switch-overlay Div
 $(".switch-overlay").removeClass("switch-overlay").addClass("switch2");
 

 $(".mobile-menu-icon").click(() => {
	 
	 $(".switch2").addClass("switch-overlay").removeClass("switch2");
	 $(".switch-overlay").click(() => {			
		 $(".sidebar-panel").removeClass("sidebar-switch-open");
		 $(".switch-overlay").removeClass("switch-overlay").addClass("switch2");
	 })
