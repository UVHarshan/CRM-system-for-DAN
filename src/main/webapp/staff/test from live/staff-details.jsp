                                                              ...
                                                              <tr>
																...
																<div
																	...
																	<button onclick="checkStaff()"
																		...
																		id="buttonEditStaffInformation">Update Staff
																		Information</button>
																</div>
															</div>
														</div>
											...
											<div class="card SDAccordionCard mb-2">
												...
												<div id="payroleInformation" class="collapse"
													...
													<div class="card-body SDAccordionCardBody">
														...
														<div
															class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-0 ContentAlignRC">
															<button onclick="checkPayroll()" class="btn btn-info"
													...
													<div class="card-body SDAccordionCardBody">
														...
														<div class="row pb-3">
															...
															<div
																...
																<button onclick="checkSkillSheet()" class="btn btn-info"
														...
														<div class="row pb-4">
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText" id="pageSpanStaffStaff">In
																	Charge Staff</div>
																<div>
																	<input type="text" id="staffStaffStaff"
																		class="form-control">
																</div>
															</div>
	  ...
	  for(i=0;i<result.data.length;i++){
	    let newRow =' <tr id="licenceTrId">'+
                         ...
                         '<td style="width: 15%;"class="p-1">'+
     				     ...
     				     '</td>'+
     				 	 '<td class="p-1"><input type="text" name="staffLicenceQualification[]" value="'+result.data[i].licenceQualification+'" class="form-control"></td>'+
     					 '<td class="p-1"><input type="text" name="staffLicenceNumber[]" value="'+result.data[i].licenceNumber+'" class="form-control"></td>'+
     					 '<td class="p-1"><input type="text" name="staffLicenceOperatingItem[]" value="'+result.data[i].licenceOperatingItem+'" class="form-control"></td>'+
     					'<td>'+
	    ...
	    let newRow = '<tr id="educationalTrId">'+
                        ...
                        '<td style="width: 15%;" class="p-1">'+
     					...
     					'</td>'+
      					...
      					'</td>'+
      					'<td class="p-1"><input type="text" name="staffInstitute[]" value="'+result.data1[i].institute+'" class="form-control"></td>'+
      					'<td class="p-1"><input type="text" name="staffQualification[]" value="'+result.data1[i].qualificationType1+'" class="form-control"></td>'+
      					'<td >'+
		    ...
		    let newRow = '<tr id="workTrId">'+
	                        ...
	                        '<td style="width: 15%;" class="p-1">'+
	     					...
	     					'</td>'+
	      					...
	      					'</td>'+
	      					'<td class="p-1"><input type="text" name="staffDesignationCredentials[]" value="'+result.data2[i].designation+'" class="form-control"></td>'+
	      					'<td class="p-1"><input type="text" name="staffCompanyNameCredentials[]" value="'+result.data2[i].companyName+'" class="form-control"></td>'+
	      					'<td class="p-1"><input type="text" name="staffExperienceTypeCredentials[]" value="'+result.data2[i].experienceType+'" class="form-control"></td>'+
	      					'<td >'+
	 ...
	 if(result.data2.length>0){ 
 	 ...
 	 for(i=0; i<result.data2.length; i++){
	   var newRowSkill= '<tr id="SkillSheetTrId">'+
		   ...
		   '<td class="p-1"><input type="text" value="'+result.data2[i].designation+'" name="staffDesignation[]" id="staffDesignation" class="form-control"></td>'+
		   '<td class="p-1"><input type="text" value="'+result.data2[i].companyName+'" name="staffCompanyName[]"  id="staffCompanyName" class="form-control"></td>'+
		   '<td class="p-1"><input type="text" value="'+result.data2[i].experienceType+'" name="staffExperienceType[]"id="staffExperienceType" class="form-control"></td>'+
		   '<td >'+
 	 ...
 	 for(i=0; i<result.data2.length; i++){
 		...
 		var newRowDependent ='<tr id="dependentTrId">'+
             '<td  class="p-1">'+
               ...
               '<input type="text"   value="'+result.data2[i].familyName+'" name="staffDependentsName[]" class="form-control"></td>'+
              '<td  class="p-1"><input type="text" value="'+result.data2[i].nameKatakana+'" name="staffDependentsNamekatakana[]" class="form-control"></td>'+
...
/* 	let Address={
		    apiKey:"dj00aiZpPWxyM2dTc2RSdHN0SyZzPWNvbnN1bWVyc2VjcmV0Jng9NmQ-",
		    fetchAddress:function (postalCode) {
		        fetch(
		            "https://map.yahooapis.jp/search/zip/V1/zipCodeSearch?query="
		            + postalCode 
		            + "&appid=" 
		            +this.apiKey  
		        )
