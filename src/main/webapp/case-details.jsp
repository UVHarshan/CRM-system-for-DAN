...
<title id="pageTitleCaseDetails">Case Details</title>
...
<body class="text-left">
									...
									<div class="col-md-4 ">
										<h1>
											<i class="fa fa-users text-30" role="generic"></i><span
												id="pageSpanHeadingCaseDetails"> Case Details</span>
										</h1>
									...
									<div class="col-md-8  ">
										...
										<div class="row pt-0 ">
											<div class="col-sm-12 pr-4  TopButDiv">
												<div class="btn-group">
												<button class="DefaultButton btn btn-info TopButtonMinWidth  dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
													<span id="buttonSpanCreateMatter"> Create from this Case</span>
												</button>
												<div class="dropdown-menu" x-placement="bottom-start">
														<a class="dropdown-item" onclick="copyCase();"> 
														<span id="dropdownCreateAnotherCase">Copy and Create Another Case</span>
														</a> 
														<a class="dropdown-item" onclick="createInvoice()"> 
														<span id="dropdownInvoiceCreation">Invoice Creation</span>
														</a> 
													</div>
												</div>
												<div class="btn-group">
												...
												<div class="btn-group">
                                                <button class="DefaultButton btn btn-danger TopButtonMinWidth  dropdown-toggle mr-2" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span id="buttonSpanCaseDelete">Delete</span></button>
                                                <div class="dropdown-menu" x-placement="bottom-start">
                                                <button class="dropdown-item" id="caseDelete" href="#"><span id="buttonValueSpanCaseDelete">Delete Case</span></button>
                                                </div>
                                               </div>
														...
														<div class="row pb-4">
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	...
																	<option value="1" id="optionDivisionByBusinessAdministrativecivilservant">Administrative civil servant</option>
																	<option value="2" id="optionDivisionByBusinessCorporategroupofficers" >Corporate / group officers</option>
																	<option value="3" id="optionDivisionByBusinessCorporategroupmanagementstaff">Corporate / group management staff</option>
																	<option value="4" id="optionDivisionByBusinessOtheradministrativeworkers">Other administrative workers</option>
																	<option value="5" id="optionDivisionByBusinessresearcher">researcher</option>
																	<option value="6" id="optionDivisionByBusinessAgricultureforestryandfisheriesengineers">Agriculture, forestry and fisheries engineers</option>
																	<option value="7" id="optionDivisionByBusinessManufacturingtechnician">Manufacturing technician</option>
																	<option value="8" id="optionDivisionByBusinessArchitectureCivilEngineeringSurveyor">Architecture / Civil Engineering / Surveyor</option>
																	<option value="9" id="optionDivisionByBusinessInformationprocessingcommunicationengineer">Information processing / communication engineer</option>
																	<option value="10" id="optionDivisionByBusinessOthertechnicians">Other technicians</option>
																	<option value="11" id="optionDivisionByBusinessDoctordentistveterinarianpharmacist">Doctor, dentist, veterinarian, pharmacist</option>
																	<option value="12" id="optionDivisionByBusinessPublichealthnursesmidwivesnurses">Public health nurses, midwives, nurses</option>
																	<option value="13" id="optionDivisionByBusinessMedicaltechnician">Medical technician</option>
																	<option value="14" id="optionDivisionByBusinessOtherhealthcareworkers">Other health care workers</option>
																	<option value="15" id="optionDivisionByBusinessSocialwelfareprofessionals">Social welfare professionals</option>
																	<option value="16" id="optionDivisionByBusinessLegalworker">Legal worker</option>
																	<option value="17" id="optionDivisionByBusinessProfessionalsinmanagementfinanceandinsurance">Professionals in management, finance, and insurance</option>
																	<option value="18" id="optionDivisionByBusinessTeacher">Teacher</option>
																	<option value="19" id="optionDivisionByBusinessReligiousperson">Religious person</option>
																	<option value="20" id="optionDivisionByBusinessWriterreportereditor">Writer, reporter, editor</option>
																	<option value="21" id="optionDivisionByBusinessArtistdesignerphotographerfilmmaker">Artist, designer, photographer, filmmaker</option>
																	<option value="22" id="optionDivisionByBusinessMusicianperformingarts">Musician, performing arts</option>
																	<option value="23" id="optionDivisionByBusinessOtherprofessionalworkers">Other professional workers</option>
																	<option value="24" id="optionDivisionByBusinessGeneralofficeworker">General office worker</option>
																	<option value="25" id="optionDivisionByBusinessAccountingclerk">Accounting clerk</option>
																	<option value="26" id="optionDivisionByBusinessProductionrelatedofficeworkers">Production-related office workers</option>
																	<option value="27" id="optionDivisionByBusinessSalessalesofficeworker">Sales / sales office worker</option>
																	<option value="28" id="optionDivisionByBusinessOutsideofficeworker">Outside office worker</option>
																	<option value="29" id="optionDivisionByBusinessTransportationandpostalofficeworkers">Transportation and postal office workers</option>
																	<option value="30" id="optionDivisionByBusinessOfficeequipmentoperator">Office equipment operator</option>
																	<option value="31" id="optionDivisionByBusinessProductsalesworker">Product sales worker</option>
																	<option value="32" id="optionDivisionByBusinessSaleslikeprofessionalworkers">Sales-like professional workers</option>
																	<option value="33" id="optionDivisionByBusinessSalespositionworker">Sales position worker</option>
																	<option value="34" id="optionDivisionByBusinessFamilylifesupportserviceprofessionalworker">Family life support service professional worker</option>
																	<option value="35" id="optionDivisionByBusinessLongtermcareserviceworker">Long-term care service worker</option>
																	<option value="36" id="optionDivisionByBusinessHealthcareserviceprofessionals">Health care service professionals</option>
																	<option value="37" id="optionDivisionByBusinessLifehygieneserviceworker">Life hygiene service worker</option>
																	<option value="38" id="optionDivisionByBusinessFoodanddrinkcook">Food and drink cook</option>
																	<option value="39" id="optionDivisionByBusinessCustomerservicewaiterworkers">Customer service / waiter workers</option>
																	<option value="40" id="optionDivisionByBusinessManagerofresidentialfacilitiesbuildings">Manager of residential facilities, buildings, etc.</option>
																	<option value="41" id="optionDivisionByBusinessOtherserviceworkers">Other service workers</option>
																	<option value="42" id="optionDivisionByBusinessSelfdefenseofficials">Self-defense officials, judicial police officers, etc.</option>
																	<option value="43" id="optionDivisionByBusinessAgriculturalist">Agriculturalist</option>
																	<option value="44" id="optionDivisionByBusinessForestryworkers">Forestry workers</option>
																	<option value="45" id="optionDivisionByBusinessFishermen">Fishermen</option>
																	<option value = "46" id="optionDivisionByBusinessProductionequipmentcontrol"> Production equipment control / monitoring worker</option>
																	<option value = "47" id="optionDivisionByBusinessMachineassemblyequipmentcontrol"> Machine assembly equipment control / monitoring worker</option>
																	<option value = "48" id="optionDivisionByBusinessProductmanufacturing"> Product manufacturing / processing workers</option>
																	<option value = "49" id="optionDivisionByBusinessMachineassembler"> Machine assembler</option>
																	<option value = "50" id="optionDivisionByBusinessMachinemaintenance"> Machine maintenance / repair workers</option>
																	<option value = "51" id="optionDivisionByBusinessProductinspector"> Product inspector</option>
																	<option value = "52" id="optionDivisionByBusinessMechanicalinspector"> Mechanical inspector</option>
																	<option value = "53" id="optionDivisionByBusinessProductionrelated"> Production-related / production-like workers </option>
																	<option value = "54" id="optionDivisionByBusinessRailwayoperator"> Railway operator </option>
																	<option value = "55" id="optionDivisionByBusinessCardriver"> Car driver </option>
																	<option value = "56" id="optionDivisionByBusinessShipaircraftoperator"> Ship / aircraft operator </option>
																	<option value = "57" id="optionDivisionByBusinessOthertransporters"> Other transporters </option>
																	<option value = "58" id="optionDivisionByBusinessStationaryconstructionmachineoperator"> Stationary / construction machine operator </option>
																	<option value = "59" id="optionDivisionByBusinessConstructionskeletonconstructionworker"> Construction skeleton construction worker </option>
																	<option value = "60" id="optionDivisionByBusinessConstructionworkers"> Construction workers (excluding construction workers) </option>
																	<option value = "61" id="optionDivisionByBusinessElectricalengineer"> Electrical engineer </option>
																	<option value = "62" id="optionDivisionByBusinessCivilengineer"> Civil engineer </option> 
																	<option value = "63" id="optionDivisionByBusinessMiner"> Miner </option>
																	<option value = "64" id="optionDivisionByBusinessTransporter"> Transporter </option>
																	<option value = "65" id="optionDivisionByBusinessCleaningworker"> Cleaning worker </option>
																	<option value = "66" id="optionDivisionByBusinessPackagingworker"> Packaging worker </option>
																	<option value = "67" id="optionDivisionByBusinessUnclassifiableoccupations"> Unclassifiable occupations </option>
																	<option value = "68" id="optionDivisionByBusinessInformationprocessingsystemdevelopment"> Information processing system development </option>
																	<option value = "69" id="optionDivisionByBusinessMechanicaldesign"> Mechanical design </option>
																	<option value = "70" id="optionDivisionByBusinessOfficeequipmentoperation"> Office equipment operation </option>
																	<option value = "71" id="optionDivisionByBusinessInterpretationtranslationshorthand"> Interpretation, translation, shorthand </option>
																	<option value = "72" id="optionDivisionByBusinessSecretary"> Secretary </option>
																	<option value = "73" id="optionDivisionByBusinessFiling"> Filing </option>
																	<option value = "74" id="optionDivisionByBusinessSurvey"> Survey </option>
																	<option value = "75" id="optionDivisionByBusinessTreasury"> Treasury </option>
																	<option value = "76" id="optionDivisionByBusinessTrade"> Trade </option>
																	<option value = "77" id="optionDivisionByBusinessDemonstration"> Demonstration </option>
																	<option value = "78" id="optionDivisionByBusinessTourguide"> Tour guide </option>
																	<option value = "79" id="optionDivisionByBusinessReceptionInformation"> Reception / Information </option>
																	<option value = "80" id="optionDivisionByBusinessRD"> R & D </option>
																	<option value = "81" id="optionDivisionByBusinessPlanningandplanningofprojectimplementationsystem"> Planning and planning of project implementation system </option>
																	<option value = "82" id="optionDivisionByBusinessProductioneditingofbooks"> Production / editing of books, etc. </Option>
																	<option value = "83" id="optionDivisionByBusinessSalesengineersalesfinancialproductsales"> Sales engineer sales, financial product sales </option>
																	<option value = "84" id="optionDivisionByBusinessAdvertisingdesign"> Advertising design </option>
																	<option value = "85" id="optionDivisionByBusinessOAinstructions"> OA instructions </option>																																										<option value=""></option>
																	</Select>
																</div>
															...
															<div class="col-sm-6 col-md-6 col-lg-6  pl-3 pr-3">
																<div class="DetailsTitleText"
																	id="pageSpanBusinessrelatedMaterials">Business-Related materials</div>
																...
																<div>
																	<button id="AddNewFile" class="btn " onclick="addSkillSheetRow()">Add New File</button>
																</div>
															</div>
														  
															<div class="col-sm-6 col-md-6 col-lg-6 pt-3 pl-3 pr-3" id="loadBusinessrelatedMaterials">
															...
															<div
																...
																<button
																	...
																	id="buttonUpdateCase">Update Case</button>
															</div>
														</div>
													...
													<div class="card-body SDAccordionCardBody">
														...
														<div class="row pb-3">
																	...
																	<table
																		...
																		<thead>
																			<tr>
																				...
																				<th style="width: 5%" class="TableTHMinWidth text-center" id="#tableImplementationDetailsTHAssemblyTime">Assembly time</th>
																				<th style="width: 5%" class="TableTHMinWidth text-center" id="#tableImplementationDetailsTHStartingTime">Starting time</th>
																				<th style="width: 5%" class="TableTHMinWidth text-center" id="#tableImplementationDetailsTHEndingTime">Ending time</th>
																				<th style="width: 5%" class="TableTHMinWidth text-center" id="#tableImplementationDetailsTHRequiredNumberOfPeople">Required number of people</th>
																		...
																		<tbody id="tbodyIdImplementationDetails">
																		   ...
																		   <td><input type="text" maxlength="5" value="" name="implementationStartTime[]" onfocusout="checkTimeFormat(this)" id="implementationStartTime" class="form-control"></td>
																		   <td><input type="text" maxlength="5" value="" name="implementationEndTime[]" onfocusout="checkTimeFormat(this)" id="implementationEndTime" class="form-control"></td>
																		   <td></td>
																		   <td >
															...
															<div class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-3 pt-2 ContentAlignRC">
																<button class="btn btn-success" onclick="duplicateImplementataionDate()" id="buttonImplementationInformationDuplicate">Duplicate the selected implementation date</button>
																...
																<button class="btn btn-info" onclick="redirectCaseImplement()" id="buttonImplementationInformation">Add Implementation Information</button>
															</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel1">Worker dispatch
				...
				<div class="modal-body">
					<p id="exampleModalLabelNote1">* Create an individual contract for dispatching workers for
						the specified period.</p>
					<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
						<div class="DetailsTitleText">
							<span id="pageSpanImplementationPeriodStart1"> Target period (start) </span>
						</div>
						<div>
							<input type="date" id="implementationPeriodStart"
								class="form-control">
					...
					<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
						<div class="DetailsTitleText">
							<span id="pageSpanImplementationPeriodEnd1"> Target period (End) </span>
						</div>
						<div>
							<input type="date" id="implementationPeriodEnd"
								class="form-control">
				...
				<div class="modal-footer">
					<button class="btn btn-primary ml-2" type="button" id="buttonWorkerDispatchIndividualContractOutput">Worker dispatch individual contract output</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel2">Dispatch source management ledger output</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
				...
				<div class="modal-body">
					<p id="exampleModalLabelNote2">Create a dispatch source management ledger for the specified period.</p>
					<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
						<div class="DetailsTitleText">
							<span id="pageSpanImplementationPeriodStart2"> Target period (start) </span>
						</div>
						<div>
							<input type="date" id="implementationPeriodStart"
								class="form-control">
					...
					<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
						<div class="DetailsTitleText">
							<span id="pageSpanImplementationPeriodEnd2"> Target period (End) </span>
						</div>
						<div>
							<input type="date" id="implementationPeriodEnd"
								class="form-control">
				...
				<div class="modal-footer">
					<button class="btn btn-primary ml-2" type="button" id="buttonDispatchSourceManagementLedgerOutput">Dispatch source management ledger output</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel3">Dispatch destination management ledger output</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
				...
				<div class="modal-body">
					<p id="exampleModalLabelNote3">Create a Dispatch destination management ledger for the specified period.</p>
					<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
						<div class="DetailsTitleText">
							<span id="pageSpanImplementationPeriodStart3"> Target
								period (start) </span>
						</div>
						<div>
							<input type="date" id="implementationPeriodStart"
					...
					<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
						<div class="DetailsTitleText">
							<span id="pageSpanImplementationPeriodEnd3"> Target period
								(End) </span>
						</div>
						<div>
							<input type="date" id="implementationPeriodEnd"
				...
				<div class="modal-footer">
					<button class="btn btn-primary ml-2" type="button" id="buttonDispatchDestinationManagementLedgerOutput">Dispatch destination management ledger output</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="exampleModal4" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel4">Output of working condition notification and working condition statement</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
				...
				<div class="modal-body">
					<p id="exampleModalLabelNote4">We will create a notification of working conditions and a written statement of working conditions for the specified period.</p>
					<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
						<div class="DetailsTitleText">
							<span id="pageSpanImplementationPeriodStart4"> Target
								period (start) </span>
						</div>
						<div>
							<input type="date" id="implementationPeriodStart"
					...
					<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
						<div class="DetailsTitleText">
							<span id="pageSpanImplementationPeriodEnd4"> Target period
								(End) </span>
						</div>
						<div>
							<input type="date" id="implementationPeriodEnd"
				...
				<div class="modal-footer">
					<button class="btn btn-primary ml-2" type="button" id="buttonWorkingConditionNotificationWorkingConditionStatement">Output of working condition notification and working condition statement</button>
				</div>
			</div>
		</div>
	</div>
  ...
  <div class="modal fade " id="inChargeStaffBatchChangeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalCenterTitleInchargeStaff">Duplicate Implementation Date</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
				...
				<div class="modal-body text-center">
					<div class="row">
					  <div class="col-5"><h4 id="titleSelectStaffInCharge">Select Date</h4></div>
					  <div class="col-7">
					  <input type="date" id="selectedDuplicateImplementationDate" class="form-control"/>
					  </div>
					</div>
	...
	<!-- 				<table class="display table table-striped table-bordered hover" id="confirm_InChargeStaffBatchChange_table" style="width: 100%">
				...
				<div class="modal-footer pt-2 pb-2">
					<button class="btn btn-danger SearchButton-2   mr-1"    id="inchargebatchChangeClose" type="button" data-dismiss="modal">Close</button>
					<button class="btn btn-info SearchButton-2  ml-0 mr-0 " id="btnImplementationDuplicate" type="button">Duplicate</button>
				</div>
			</div>
		</div>
	...
	<script src="./dist-assets/js/case-details-validate.js"></script>
	...
	<script>
	    ...
	    const caseId = "<%= request.getParameter("caseId")%>" ;
	    let passDataReport = {"caseId" : caseId};
			...
			$.ajax({
				...
				success : function(result, status, request) {
					if (result.status == 200) {
						...
						var selectSalesRepresentative  = document.getElementById('SalesRepresentative');
						...
						if(result.data != null)
						{
							...
							for(i=0 ; i<result.data.length; i++ )
							{
								...
								selectSalesRepresentative.options[selectSalesRepresentative.options.length] = new Option(result.data[i].name, result.data[i].value);
							}
		...
		//wishwa
        $("#buttonWorkerDispatchIndividualContractOutput").click(function( event ) { 
       	   $.ajax({
                 beforeSend: function(request) {
              	  document.getElementById("loaderNotify").style.display = "";
                  request.setRequestHeader("GUID", GUID);
                 },
                 url: serverHTTP +'Case/DispatchIndividualCSVOutput',
                 method: 'POST',
                 contentType: 'application/json',
                 data: JSON.stringify(passDataReport),
                 dataType: 'json',
                  success: function(result, status, request){
                  if(result.status==200)
                 	 {
        ...
        $("#buttonDispatchSourceManagementLedgerOutput").click(function( event ) { 
        	   $.ajax({
                  beforeSend: function(request) {
               	  document.getElementById("loaderNotify").style.display = "";
                   request.setRequestHeader("GUID", GUID);
                  },
                  url: serverHTTP +'Case/DispatcherManagementCSVOutput',
                  method: 'POST',
                  contentType: 'application/json',
                  data: JSON.stringify(passDataReport),
                  dataType: 'json',
        ...
        $("#buttonDispatchDestinationManagementLedgerOutput").click(function( event ) { 
     	   $.ajax({
               beforeSend: function(request) {
            	  document.getElementById("loaderNotify").style.display = "";
                request.setRequestHeader("GUID", GUID);
               },
               url: serverHTTP +'Case/DispatchDesignationCSVOutput',
               method: 'POST',
               contentType: 'application/json',
               data: JSON.stringify(passDataReport),
               dataType: 'json',
       ...
       $("#buttonWorkingConditionNotificationWorkingConditionStatement").click(function( event ) { 
     	   $.ajax({
               beforeSend: function(request) {
            	  document.getElementById("loaderNotify").style.display = "";
                request.setRequestHeader("GUID", GUID);
               },
               url: serverHTTP +'Case/WorkingConditionCSVOutput',
               method: 'POST',
               contentType: 'application/json',
               data: JSON.stringify(passDataReport),
               dataType: 'json',
		...
		function getQuotationInfo(result) {
			...
			document.getElementById("inputCaseNumber").value = result.data.caseNumber;
			...
			document.getElementById("assignmentClassification").value = result.data.assignmentClassification;
			...
			document.getElementById("DivisionByBusiness").value = result.data.divisionByBusiness;
			document.getElementById("ItemUnitPrice").value = result.data.itemUnitPriceSetting;	
			document.getElementById("ConflictDate").value = result.data.contractDate;
			document.getElementById("PersonInCharge").value = result.data.personInChargeOfCase;
			document.getElementById("SalesRepresentative").value = result.data.salesRepresentative;
			document.getElementById("assignmentDeadline").value = result.data.deadline;
			document.getElementById("DetailedInformationPractice").value = result.data.detailInfo;
			document.getElementById("companyRemarks").value = result.data.remarks;
			
			$('#CaseOpenCheck').prop('checked',
					result.data.caseOpen);
			...
			if (document.getElementById("dispatchClassification").value != 4) {
				...
				document.getElementById("RequiredQualifications").value = result.data.necessaryQualification;
			} else {
				...
				document.getElementById("recruitmentPeriodStart").value =  result.data.periodEndDate;
				document.getElementById("recruitmentPeriodEnd").value =  result.data.periodStartDate;
			...
			var addingtext = "" ;
		     for(w=0;w<result.data.businessMaterials.length;w++)
				{
		    	//addingtext =  '<div class="col-sm-6 col-md-6 col-lg-6  pl-3 pr-3"> <a target="blank" href="'+result.data.businessMaterials[w].materialPath+'">Business-Related material '+(w+1)+'</a> </div>';
		    	addingtext =  '<span class="pt-3 pl-0 pr-3 pb-4"> <a target="blank" style="font-size: 1.0rem;" href="'+result.data.businessMaterials[w].materialPath+'">Business-Related material '+(w+1)+'</a> </span> <button class="btn btn-danger mr-1 mb-1" onclick="removeBusinessFile(this,'+result.data.businessMaterials[w].id+')"><i class="fa fa-trash"></i></button></br>'; 
		    	document.getElementById("loadBusinessrelatedMaterials").innerHTML	 += addingtext ;
				}
		}
		

	function removeBusinessFile( node,id ) {

			cancelText = notificationArray["N0004"];
			titleText = notificationArray["N1263"];
			...
			url: serverHTTP +'Case/DeleteBusinessMaterial',
			method: 'POST',
			contentType: 'application/json',
		...
		function copyCase()
		{
			sessionStorage.setItem("id", caseId);	
	    	window.location.href = "case-duplicate.jsp";
		}

		
		//wishwa
		function addSkillSheetRow() {
			var $tr = $("#testTryInnerDiv");
			var $clone = $tr.clone();
		...
		function addImplementDayRow(){
			...
			var $clone = $tr.clone();
			$clone.find('input').val('');
			$("#tbodyIdImplementationDetails").append($clone);
		}
		...
		function duplicateImplementataionDate() {
		 let tableCheckNode = document.querySelectorAll('input[name="implementDuplicateelection[]"]:checked');
		...
		function showSearchResult(result, request) {
			...
			for(i=0; i<result.data.length; i++){
				...
				startImplementationDate = result.data[i].startImplementationDate != null ? result.data[i].startImplementationDate: "";
				endImplementationDate = result.data[i].endImplementationDate != null ? result.data[i].endImplementationDate: "";
				workLocation = result.data[i].workLocation != null ? result.data[i].workLocation: "";
				assemblyTime = result.data[i].assemblyTime != null ? result.data[i].assemblyTime: "";
				startTime = result.data[i].startTime != null ? result.data[i].startTime: "";
				endTime = result.data[i].endTime != null ? result.data[i].endTime: "";
				requiredNoOfPeople = result.data[i].requiredNoOfPeople != null ? result.data[i].requiredNoOfPeople: "";
				   ...
				   var newRowSkill= '<tr id="SkillSheetTrId">'+
                       ...
                       '<input type="checkbox" id="implementationDuplicateSelection" name="implementationDuplicateSelection[]" class="tableCheckClass" value="'+result.data[i].implementationId+'">'+
                      ' <span class="checkmark"></span>'+
                      '</label>'+
             			'</td>'   
					   +
					   '<td>'+startImplementationDate+" ~ "+endImplementationDate+'</td>'+
					   '<td><input type="text" value="'+workLocation+'" name="implementationWorkLocation[]"  id="implementationWorkLocation" class="form-control"></td>'+
					   '<td><input type="time" value="'+assemblyTime+'" name="implementationAssemblyTime[]"id="implementationAssemblyTime" class="form-control"></td>'+
					   '<td><input type="text" maxlength="5" value="'+startTime+'" name="implementationStartTime[]" onfocusout="checkTimeFormat(this)" id="implementationStartTime" class="form-control"></td>'+
					   '<td><input type="text" maxlength="5" value="'+endTime+'" name="implementationEndTime[]" onfocusout="checkTimeFormat(this)"  id="implementationEndTime" class="form-control"></td>'+
					   '<td>'+requiredNoOfPeople+'</td>'+
					   '<td >'+
						'<button class="btn DetailsButton ml-1" onclick="viewDetails('
						+result.data[i].caseId+', '+ result.data[i].implementationId+')" title="Implementation Details" role="button" id="tableButtonImplementationDetails"><i class="fa fa-info-circle"></i></button>'+
						'<button class="btn SuccessColor ml-1 mt-2" style="color:white;" onclick="duplicateImplementataionDate()" title="Duplicate Implementation Details"><i class="far fa-clone"></i></span></button>'+
						'<button class="btn btn-danger ml-1 mt-2" onclick="confirmDelete('+ result.data[i].implementationId+ ')" title="Delete Implementation" role="button" id="tableButtonImplementationDelete"><i class="fa fa-trash"></i></button>'+
						'</td>'+
					   '</tr>';  
		...
		function viewDetails(caseId, implementationId) {
		...
		$("#caseDelete").click(function( event ) { 
		  	   ...
		  	   dataNode['id'] = caseId;  
		    	   ...
		    	   $.ajax({
		             ...
		             url: serverHTTP +'Case/DeleteCaseInfo',
		             method: 'POST',
		             contentType: 'application/json',
		             data: JSON.stringify(dataNode),
		             dataType: 'json',
		...
		function deleteImplementation(implementationId)
		{
			var dataNode = {};     
		  	   dataNode['id'] = implementationId;  
		    	   ...
		    	   $.ajax({
		             ...
		             url: serverHTTP +'Case/DeleteImplementationInfo',
		             method: 'POST',
		             contentType: 'application/json',
		             data: JSON.stringify(dataNode),
		             dataType: 'json',
		...
		function businessrelatedMaterialsUplod()
		{
			var filePath = "";
			var businessrelatedMaterialsArray = document.getElementsByName("businessrelatedMaterials[]");
			var businessMaterialArray = [];
			...
			formDataObj.append('uuid', "BRM"  );
			formDataObj.append('serviceId', caseId);
		 	...
		 	$.ajax({
			  ...
			  success : function(result, status, request) {
			       ...
			       businessMaterialArray.push(tempBusinessMaterial);
			...
			setFilePath(businessMaterialArray);
	    }
		
		function setFilePath(value){
			
            let caseNode = {};
			caseNode['caseId'] = caseId;
			caseNode['businessMaterialDto'] = value;
			...
			{ 
				$.ajax({
					...
					url : serverHTTP + 'Case/SaveBusinessMaterials',
					method : 'POST',
					contentType : 'application/json',
					data : JSON.stringify(caseNode),
					dataType : 'json',
...
/* 		
		$("#buttonImplementationInformationBatchUpdate").click(function( event ) { 
	    	
		  	   var dataNode = {};     
		  	   dataNode['id'] = caseId;  
		  	   var editImplementationDtoList = [];
		  	   
		  	    var implementationIdArray = document.getElementsByName('implementationId[]');
		    	var implementationWorkLocationArray = document.getElementsByName('implementationWorkLocation[]'); 
		    	var implementationAssemblyTimeArray = document.getElementsByName('implementationAssemblyTime[]'); 
		    	var implementationStartTimeArray = document.getElementsByName('implementationStartTime[]');  
		    	var implementationEndTimeArray = document.getElementsByName('implementationEndTime[]');
		    	
		    	for(var i = 0; i < implementationIdArray.length; i++)
		    	{
		    		 var implementationId = implementationIdArray[i].value !="" ? implementationIdArray[i].value : null;
		    		 var implementationWorkLocation = implementationWorkLocationArray[i].value !="" ? implementationWorkLocationArray[i].value : null;
		    		 var implementationAssemblyTime = implementationAssemblyTimeArray[i].value !="" ? implementationAssemblyTimeArray[i].value : null;
		    		 var implementationStartTime = implementationStartTimeArray[i].value !="" ? implementationStartTimeArray[i].value.trim() : null;
		    		 var implementationEndTime = implementationEndTimeArray[i].value !="" ? implementationEndTimeArray[i].value.trim() : null;
		    		 
		    		 var tempImplementationDtoList ={"id":implementationId,
			    				    "workLocation":implementationWorkLocation,
							        "meetingTime":implementationAssemblyTime,
							        "startTime":implementationStartTime,
							        "endTime":implementationEndTime
						        };
				 
		    		 editImplementationDtoList.push(tempImplementationDtoList);
		    	}
		    	
		    	dataNode['editImplementationDtoList'] = editImplementationDtoList;
		    	   ...
		    	   $.ajax({
		             ...
		             url: serverHTTP +'Case/EditImplementation',
		             method: 'POST',
		             contentType: 'application/json',
		             data: JSON.stringify(dataNode),
		             dataType: 'json',
		 ...
		 */
/* 		//wishwa
		$("#buttonImplementationInformationDuplicate1").click(function( event ) { 
	   ...
	   $("#btnImplementationDuplicate").click(function( event ) { 
		       let tableCheckNode = document.querySelectorAll('input[name="implementationDuplicateSelection[]"]:checked');
        	   let selectedDuplicateImplementationDate = document.getElementById("selectedDuplicateImplementationDate").value;
              //wishwa temp till calander add
        	  if(selectedDuplicateImplementationDate != "" && tableCheckNode.length>0){
            	  let dataNode = {};
            	  let dataArray = [];
            	   for(var i = 0; i < tableCheckNode.length ; i++)
               		{ 
            		   var dataSet = {"id":tableCheckNode[i].value,
    		                  		  "startImplementationDate":selectedDuplicateImplementationDate,
    		       		 			  "endImplementationDate":null
    		       		 			  };
            		     dataArray.push(dataSet);
               		}

            	   dataNode['duplicateImplementationDtoList'] = dataArray;
            	   ...
            	   $.ajax({
                       ...
                       url: serverHTTP +'Case/DuplicateImplementation',
                       method: 'POST',
                       contentType: 'application/json',
                       data: passData,
                       dataType: 'json',
	   ...
	   $("#buttonImplementationInformationBatchUpdate").click(function( event ) { 
          ...
          if(tableCheckNode.length>0)
          {
        	  ...
        	  let dataArray = [];
        	   for(var i = 0; i < tableCheckNode.length ; i++)
        		   ...
        		   var dataSet = {"id":tableCheckNode[i].value,
    	                  		  "workLocation":parentRow.find("td:eq(3) input[type='text']").val(),
    	       		 			  "meetingTime": parentRow.find("td:eq(4) input[type='time']").val(),
    	       		 			  "startTime":   parentRow.find("td:eq(5) input[type='time']").val(),
    	       		 			  "endTime":     parentRow.find("td:eq(6) input[type='time']").val()
    	       		 			  };
        		     dataArray.push(dataSet);
           		}

        	   dataNode['editImplementationDtoList'] = dataArray;
        	   passData = JSON.stringify(dataNode);
		...
		function createInvoice()
		{
			...
			let IcompanyId = document.getElementById("CustomerCompanyID").value;
			let form = $('<form action="' + url + '" method="post">' +
					      '<input type="hidden" name="CaseId" value="'+caseId+'" />' +
				          '<input type="hidden" name="companyId" value="'+IcompanyId+'" />' +
						  '</form>');
			$('body').append(form);
			form.submit();
		}
