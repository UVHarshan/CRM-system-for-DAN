									...
									<div class="col-md-4 ">
										<h1>
											<i class="fa fa-users text-30" role="generic"></i><span
												id="pageSpanHeadingCaseRegistration"> Case
												Registration</span>
										</h1>
												...
												<!-- <div class="btn-group">
													...
													<div class="dropdown-menu" x-placement="bottom-start">
														<a class="dropdown-item" href="#"> <span
															id="dropdownInvoiceCreation" data-toggle="modal"
															data-target="#exampleModal2">Invoice Creation</span>
														</a>
													</div>
												</div>
												<div class="btn-group">
													...
													<div class="dropdown-menu" x-placement="bottom-start">
														<a class="dropdown-item" href="#"> <span
															...
															class="dropdown-item"><span id="creationofdispatch"
															data-toggle="modal" data-target="#exampleModal5">Creation
																of dispatch notice </span></a>
													</div>
												</div> -->
													...
													<div class="card-body SDAccordionCardBody">
														<div class="row pb-4">
															...
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="hidden" id="quotationID"
																		...
																		type="text" readonly id="QuotationNumber"
																		class="form-control" maxlength="255">
																</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<Select id="dispatchClassification"
																		...
																		role="combobox">
																		<option value="" id="optionDispatchClassification">Select
																			Dispatch Classification</option>
																		<option value="1"
																			id="optionDispatchClassificationGeneralDispatch">General
																			Dispatch</option>
																		<option value="2"
																			id="optionDispatchClassificationBusinessContract">Out
																			Sourcing</option>
																		<option value="3"
																			id="optionDispatchClassificationIntroductionDispatching">Introduction
																			Dispatching</option>
																		<option value="4"
																			id="optionDispatchClassificationRecruitment">Recruitment</option>
																		<option value="5"
																			id="optionDispatchClassificationPartTime">Part
																			Time</option>
																	</Select>
																</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<Select id="DivisionByBusiness" class="form-control">
																		<option value="1"
																			id="optionDivisionByBusinessAdministrativecivilservant">Administrative
																			civil servant</option>
																		<option value="2"
																			id="optionDivisionByBusinessCorporategroupofficers">Corporate
																			/ group officers</option>
																		<option value="3"
																			id="optionDivisionByBusinessCorporategroupmanagementstaff">Corporate
																			/ group management staff</option>
																		<option value="4"
																			id="optionDivisionByBusinessOtheradministrativeworkers">Other
																			administrative workers</option>
																		<option value="5"
																			id="optionDivisionByBusinessresearcher">researcher</option>
																		<option value="6"
																			id="optionDivisionByBusinessAgricultureforestryandfisheriesengineers">Agriculture,
																			forestry and fisheries engineers</option>
																		<option value="7"
																			id="optionDivisionByBusinessManufacturingtechnician">Manufacturing
																			technician</option>
																		<option value="8"
																			id="optionDivisionByBusinessArchitectureCivilEngineeringSurveyor">Architecture
																			/ Civil Engineering / Surveyor</option>
																		<option value="9"
																			id="optionDivisionByBusinessInformationprocessingcommunicationengineer">Information
																			processing / communication engineer</option>
																		<option value="10"
																			id="optionDivisionByBusinessOthertechnicians">Other
																			technicians</option>
																		<option value="11"
																			id="optionDivisionByBusinessDoctordentistveterinarianpharmacist">Doctor,
																			dentist, veterinarian, pharmacist</option>
																		<option value="12"
																			id="optionDivisionByBusinessPublichealthnursesmidwivesnurses">Public
																			health nurses, midwives, nurses</option>
																		<option value="13"
																			id="optionDivisionByBusinessMedicaltechnician">Medical
																			technician</option>
																		<option value="14"
																			id="optionDivisionByBusinessOtherhealthcareworkers">Other
																			health care workers</option>
																		<option value="15"
																			id="optionDivisionByBusinessSocialwelfareprofessionals">Social
																			welfare professionals</option>
																		<option value="16"
																			id="optionDivisionByBusinessLegalworker">Legal
																			worker</option>
																		<option value="17"
																			id="optionDivisionByBusinessProfessionalsinmanagementfinanceandinsurance">Professionals
																			in management, finance, and insurance</option>
																		<option value="18"
																			id="optionDivisionByBusinessTeacher">Teacher</option>
																		<option value="19"
																			id="optionDivisionByBusinessReligiousperson">Religious
																			person</option>
																		<option value="20"
																			id="optionDivisionByBusinessWriterreportereditor">Writer,
																			reporter, editor</option>
																		<option value="21"
																			id="optionDivisionByBusinessArtistdesignerphotographerfilmmaker">Artist,
																			designer, photographer, filmmaker</option>
																		<option value="22"
																			id="optionDivisionByBusinessMusicianperformingarts">Musician,
																			performing arts</option>
																		<option value="23"
																			id="optionDivisionByBusinessOtherprofessionalworkers">Other
																			professional workers</option>
																		<option value="24"
																			id="optionDivisionByBusinessGeneralofficeworker">General
																			office worker</option>
																		<option value="25"
																			id="optionDivisionByBusinessAccountingclerk">Accounting
																			clerk</option>
																		<option value="26"
																			id="optionDivisionByBusinessProductionrelatedofficeworkers">Production-related
																			office workers</option>
																		<option value="27"
																			id="optionDivisionByBusinessSalessalesofficeworker">Sales
																			/ sales office worker</option>
																		<option value="28"
																			id="optionDivisionByBusinessOutsideofficeworker">Outside
																			office worker</option>
																		<option value="29"
																			id="optionDivisionByBusinessTransportationandpostalofficeworkers">Transportation
																			and postal office workers</option>
																		<option value="30"
																			id="optionDivisionByBusinessOfficeequipmentoperator">Office
																			equipment operator</option>
																		<option value="31"
																			id="optionDivisionByBusinessProductsalesworker">Product
																			sales worker</option>
																		<option value="32"
																			id="optionDivisionByBusinessSaleslikeprofessionalworkers">Sales-like
																			professional workers</option>
																		<option value="33"
																			id="optionDivisionByBusinessSalespositionworker">Sales
																			position worker</option>
																		<option value="34"
																			id="optionDivisionByBusinessFamilylifesupportserviceprofessionalworker">Family
																			life support service professional worker</option>
																		<option value="35"
																			id="optionDivisionByBusinessLongtermcareserviceworker">Long-term
																			care service worker</option>
																		<option value="36"
																			id="optionDivisionByBusinessHealthcareserviceprofessionals">Health
																			care service professionals</option>
																		<option value="37"
																			id="optionDivisionByBusinessLifehygieneserviceworker">Life
																			hygiene service worker</option>
																		<option value="38"
																			id="optionDivisionByBusinessFoodanddrinkcook">Food
																			and drink cook</option>
																		<option value="39"
																			id="optionDivisionByBusinessCustomerservicewaiterworkers">Customer
																			service / waiter workers</option>
																		<option value="40"
																			id="optionDivisionByBusinessManagerofresidentialfacilitiesbuildings">Manager
																			of residential facilities, buildings, etc.</option>
																		<option value="41"
																			id="optionDivisionByBusinessOtherserviceworkers">Other
																			service workers</option>
																		<option value="42"
																			id="optionDivisionByBusinessSelfdefenseofficials">Self-defense
																			officials, judicial police officers, etc.</option>
																		<option value="43"
																			id="optionDivisionByBusinessAgriculturalist">Agriculturalist</option>
																		<option value="44"
																			id="optionDivisionByBusinessForestryworkers">Forestry
																			workers</option>
																		<option value="45"
																			id="optionDivisionByBusinessFishermen">Fishermen</option>
																		<option value="46"
																			id="optionDivisionByBusinessProductionequipmentcontrol">
																			Production equipment control / monitoring worker</option>
																		<option value="47"
																			id="optionDivisionByBusinessMachineassemblyequipmentcontrol">
																			Machine assembly equipment control / monitoring
																			worker</option>
																		<option value="48"
																			id="optionDivisionByBusinessProductmanufacturing">
																			Product manufacturing / processing workers</option>
																		<option value="49"
																			id="optionDivisionByBusinessMachineassembler">
																			Machine assembler</option>
																		<option value="50"
																			id="optionDivisionByBusinessMachinemaintenance">
																			Machine maintenance / repair workers</option>
																		<option value="51"
																			id="optionDivisionByBusinessProductinspector">
																			Product inspector</option>
																		<option value="52"
																			id="optionDivisionByBusinessMechanicalinspector">
																			Mechanical inspector</option>
																		<option value="53"
																			id="optionDivisionByBusinessProductionrelated">
																			Production-related / production-like workers</option>
																		<option value="54"
																			id="optionDivisionByBusinessRailwayoperator">
																			Railway operator</option>
																		<option value="55"
																			id="optionDivisionByBusinessCardriver">Car
																			driver</option>
																		<option value="56"
																			id="optionDivisionByBusinessShipaircraftoperator">
																			Ship / aircraft operator</option>
																		<option value="57"
																			id="optionDivisionByBusinessOthertransporters">
																			Other transporters</option>
																		<option value="58"
																			id="optionDivisionByBusinessStationaryconstructionmachineoperator">
																			Stationary / construction machine operator</option>
																		<option value="59"
																			id="optionDivisionByBusinessConstructionskeletonconstructionworker">
																			Construction skeleton construction worker</option>
																		<option value="60"
																			id="optionDivisionByBusinessConstructionworkers">
																			Construction workers (excluding construction workers)
																		</option>
																		<option value="61"
																			id="optionDivisionByBusinessElectricalengineer">
																			Electrical engineer</option>
																		<option value="62"
																			id="optionDivisionByBusinessCivilengineer">
																			Civil engineer</option>
																		<option value="63" id="optionDivisionByBusinessMiner">
																			Miner</option>
																		<option value="64"
																			id="optionDivisionByBusinessTransporter">
																			Transporter</option>
																		<option value="65"
																			id="optionDivisionByBusinessCleaningworker">
																			Cleaning worker</option>
																		<option value="66"
																			id="optionDivisionByBusinessPackagingworker">
																			Packaging worker</option>
																		<option value="67"
																			id="optionDivisionByBusinessUnclassifiableoccupations">
																			Unclassifiable occupations</option>
																		<option value="68"
																			id="optionDivisionByBusinessInformationprocessingsystemdevelopment">
																			Information processing system development</option>
																		<option value="69"
																			id="optionDivisionByBusinessMechanicaldesign">
																			Mechanical design</option>
																		<option value="70"
																			id="optionDivisionByBusinessOfficeequipmentoperation">
																			Office equipment operation</option>
																		<option value="71"
																			id="optionDivisionByBusinessInterpretationtranslationshorthand">
																			Interpretation, translation, shorthand</option>
																		<option value="72"
																			id="optionDivisionByBusinessSecretary">
																			Secretary</option>
																		<option value="73" id="optionDivisionByBusinessFiling">
																			Filing</option>
																		<option value="74" id="optionDivisionByBusinessSurvey">
																			Survey</option>
																		<option value="75"
																			id="optionDivisionByBusinessTreasury">
																			Treasury</option>
																		<option value="76" id="optionDivisionByBusinessTrade">
																			Trade</option>
																		<option value="77"
																			id="optionDivisionByBusinessDemonstration">
																			Demonstration</option>
																		<option value="78"
																			id="optionDivisionByBusinessTourguide">Tour
																			guide</option>
																		<option value="79"
																			id="optionDivisionByBusinessReceptionInformation">
																			Reception / Information</option>
																		<option value="80" id="optionDivisionByBusinessRD">
																			R & D</option>
																		<option value="81"
																			id="optionDivisionByBusinessPlanningandplanningofprojectimplementationsystem">
																			Planning and planning of project implementation
																			system</option>
																		<option value="82"
																			id="optionDivisionByBusinessProductioneditingofbooks">
																			Production / editing of books, etc.</Option>
																		<option value="83"
																			id="optionDivisionByBusinessSalesengineersalesfinancialproductsales">
																			Sales engineer sales, financial product sales</option>
																		<option value="84"
																			id="optionDivisionByBusinessAdvertisingdesign">
																			Advertising design</option>
																		<option value="85"
																			id="optionDivisionByBusinessOAinstructions">
																			OA instructions</option>
																		<option value=""></option>
																	</Select>
																</div>
															...
															<div class="row pt-3 pb-3 pl-3 pr-3"
																id="dispatchLoaderID" style="display: none">
																<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																	<div class="DetailsTitleText">
																...
																<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																	...
																	<div>
																		<Select id="ItemUnitPrice" class="form-control">
																			<option value=""
																				id="optionSelectCaseUnitPriceSetting">Select
																				Case unit price setting</option>
																			<option value="1"
																				id="optionSelectCaseUnitPriceSettingDailySalary">Daily
																				Salary</option>
																			<option value="2"
																				id="optionSelectCaseUnitPriceSettingHourlyWage">Hourly
																				Wage</option>
																			<option value="3"
																				id="optionSelectCaseUnitPriceSettingFullMonthlySalary">Full
																				Monthly Salary</option>
																			<option value="4"
																				id="optionSelectCaseUnitPriceSettingDaytoMonth">Day
																				to month</option>
																		</Select>
																	</div>
															...
															<div class="row pt-3 pb-3 pl-3 pr-3"
																id="dispatchLoader2ID" style="display: none">
															...
															<div
																...
																<div>
																	<textarea id="ConflictDate" class="form-control"
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanPersonInCharge"> The person in
																		charge of the case</span><span class="RequiredStar"> *</span>
																</div>
																<div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="hidden" id="CustomerCompanyID"
																		class="form-control" readonly="readonly"> <input
																		type="text" readonly id="CustomerCompanyName"
																		class="form-control">
																</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanAssignmentDeadline">
																		Assignment deadline </span><span class="RequiredStar">
																		*</span>
																</div>
																<div>
														...
														<div class="row">
															...
															<div class="col-sm-6 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																<div class="DetailsTitleText"
																...
																<div id="testTry">
																	<form method="POST" enctype="multipart/form-data"
																		...
																		<input type="hidden" value=""
																			name="businessrelatedMaterialsId[]" /> <input
																			type="file" id="staffBusinessrelatedMaterials"
																			name="businessrelatedMaterials[]"
																			class="form-control mb-2" onchange="loadFile(event)">
																	</form>
																</div>
																<div>
																	<button id="AddNewFile" class="btn "
																		onclick="addSkillSheetRow()">Add New File</button>
																</div>
															</div>
															...
															<div
																...
																<button
																	...
																	id="buttonSaveCase">Save Case</button>
															</div>
														</div>
													...
													<div class="card-body SDAccordionCardBody">
														...
														<div class="row pb-3">
																	...
																	<table
																		...
																		<thead>
																			<tr>
																				<th class="text-center"
																					id="#tableImplementationDetailsTHNo">No</th>
																				<th class="TableTHMinWidth text-center"
																					id="#tableImplementationDetailsTHDuplicateSelection">Duplicate
																					selection</th>
																				<th class="TableTHMinWidth text-center"
																					id="#tableImplementationDetailsTHImplementationPeriod">Implementation
																					period Invoice creation</th>
																				<th class="TableTHMinWidth text-center"
																					id="#tableImplementationDetailsTHWorkLocation">Work
																					location</th>
																				<th class="TableTHMinWidth text-center"
																					id="#tableImplementationDetailsTHAssemblyTime">Assembly
																					time</th>
																				<th class="TableTHMinWidth text-center"
																					id="#tableImplementationDetailsTHStartingTime">Starting
																					time</th>
																				<th class="TableTHMinWidth text-center"
																					id="#tableImplementationDetailsTHEndingTime">Ending
																					time</th>
																				<th class="TableTHMinWidth text-center"
																					id="#tableImplementationDetailsTHRequiredNumberOfPeople">Required
																					number of people</th>
																			</tr>
																		</thead>
																		...
																		<tbody id="tbodyIdImplementationDetails">
																			<tr id="SkillSheetTrId">
																				...
																				<td style="width: 5%;"></td>
																				<td style="width: 10%;" class="p-1"><input
																					type="checkbox" value=""
																					name="implementationDuplicateSelection[]"
																					id="implementationDuplicateSelection"
																					class="form-control"></td>
																				<td></td>
																				<td><input type="text" value=""
																					name="implementationWorkLocation[]"
																					id="implementationWorkLocation"
																					class="form-control"></td>
																				<td><input type="text" value=""
																					name="implementationAssemblyTime[]"
																					id="implementationAssemblyTime"
																					class="form-control"></td>
																				<td><input type="text" value=""
																					name="implementationStartTime[]"
																					id="implementationStartTime" class="form-control"></td>
																				<td><input type="text" value=""
																					name="implementationEndTime[]"
																					id="implementationEndTime" class="form-control"></td>
																				<td></td>
																				<td>
																					<button class="btn DetailsButton ml-1"
																						onclick="viewDetails(result.data[i].caseId)"
															...
															<div
																...
																<button class="btn btn-success" onclick="disableBtn()"
																	id="buttonImplementationInformationDuplicate">Duplicate
																	the selected implementation date</button>
																<button class="btn btn-success"
																	id="buttonImplementationInformationBatchUpdate">Implementation
																	information batch update</button>
																<button class="btn btn-info"
																	onclick="redirectCaseImplement()"
																	id="buttonImplementationInformation">Add
	...
	<script>
									...
									.ajax({
										...
										success : function(result, status,
											...
											if (result.status == 200) {
												console.log("ok")
												var select = document
														.getElementById('PersonInCharge');
												var selectSalesRepresentative = document
														.getElementById('SalesRepresentative');
												...
												if (result.data != null) {
													...
													for (i = 0; i < result.data.length; i++) {
														select.options[select.options.length] = new Option(
																result.data[i].name,
																result.data[i].value);
														selectSalesRepresentative.options[selectSalesRepresentative.options.length] = new Option(
																result.data[i].name,
																result.data[i].value);
													}
		...
		function getQuotationInfo(result) {
			$('#dispatchClassification')
					.val(result.data.dispatchClassification);
			checkDispatch();
			loadDispatch();
			document.getElementById("caseName").value = result.data.caseName;
			//document.getElementById("caseNumber").value = result.data.caseNumber;
			...
			$('#CaseOpenCheck').prop('checked', result.data.caseOpen);
		...
		function saveCaseInfo() {
			...
			var assignmentClassification = document
					.getElementById("assignmentClassification").value != "" ? document
					.getElementById("assignmentClassification").value
					: null;
			var divisionByBusiness = document
					.getElementById("DivisionByBusiness").value != "" ? document
					.getElementById("DivisionByBusiness").value
					: null;
			var dispatchClassification = document
					.getElementById("dispatchClassification").value != "" ? document
			...
			if (dispatchClassification != 4) {
				...
				var workLocation = document.getElementById("worklocation").value != "" ? document
						.getElementById("worklocation").value.trim()
						: null;
				var qualifications = document
						.getElementById("RequiredQualifications").value.trim();
				var periodStartDate = document
						.getElementById("implementationPeriodStart").value != "" ? document
						.getElementById("implementationPeriodStart").value
						: null;
				var periodEndDate = document
				...
				var businessContent = document
						.getElementById("businessContent1").value.trim();
				var workLocation = document.getElementById("workLocation1").value
						.trim();
				var qualifications = document
						.getElementById("ApplicationQualifications").value
						.trim();
				var periodStartDate = document
						.getElementById("recruitmentPeriodStart").value != "" ? document
						.getElementById("recruitmentPeriodStart").value
						: null;
				var periodEndDate = document
						.getElementById("recruitmentPeriodEnd").value != "" ? document
						.getElementById("recruitmentPeriodEnd").value
						: null;

			}

			var itemUnitPriceSetting = document.getElementById("ItemUnitPrice").value != "" ? document
					.getElementById("ItemUnitPrice").value
					: null;
			var requiredNoOfPeople = document
					.getElementById("requiredNumberPeople").value.trim();

			var workingHoursStart = document
					.getElementById("workingHoursStart1").value.trim();
			var workingHoursEnd = document.getElementById("workingHoursEnd1").value
					.trim();
			...
			var numberOfHires = document.getElementById("numberOfHires").value
					.trim();
			...
			var personInChargeOfCase = document
					.getElementById("PersonInCharge").value != "" ? document
					.getElementById("PersonInCharge").value : null;
			var salesRepresentative = document
					.getElementById("SalesRepresentative").value != "" ? document
					.getElementById("SalesRepresentative").value
					: null;
			var deadline = document.getElementById("assignmentDeadline").value != "" ? document
					.getElementById("assignmentDeadline").value
					: null;
			var remarks = document.getElementById("companyRemarks").value
					.trim();
			...
			var detailInfo = document
					.getElementById("DetailedInformationPractice").value.trim();

			var businessrelatedMaterialsIdArray = document
					.getElementsByName("businessrelatedMaterialsId[]");
			var materialPathArray = document
					.getElementsByName("businessrelatedMaterials[]");

			var dataArrayBusinessMaterial = [];

			for (var i = 0; i < businessrelatedMaterialsIdArray.length; i++) {
				var businessrelatedMaterialsId = businessrelatedMaterialsIdArray[i].value != "" ? businessrelatedMaterialsIdArray[i].value
						: null;
				var materialPath = materialPathArray[i].value != "" ? materialPathArray[i].value
						.trim()
						: null;
					...
					.ajax({
						...
						success : function(result, status, request) {
							if (result.status == 202) {
								...
								businessrelatedMaterialsUplod(result.data.id);

								sessionStorage.setItem("id", result.data.id);
								caseId = sessionStorage.getItem("id");
								...
								checkMessage('success', 'N1231', 'N0000',
										caseNumber, "");
		...
		function disableBtn() {
			const tableCheckNode = document
					.querySelectorAll('input[name="implementDuplicateelection[]"]:checked');
			if (tableCheckNode.length == 0) {
				document
						.getElementById("buttonImplementationInformationDuplicate").disabled = true;
			} else {
				document
						.getElementById("buttonImplementationInformationDuplicate").disabled = false;
			}
		}
		...
		function showSearchResult(result, request) {
			...
			for (i = 0; i < result.data.length; i++) {
				...
				var newRowSkill = '<tr id="SkillSheetTrId">'
						...
						+ '<td><input type="text" value="'+assemblyTime+'" name="implementationAssemblyTime[]"id="implementationAssemblyTime" class="form-control"></td>'
						+ '<td><input type="text" value="'+startTime+'" name="implementationStartTime[]"id="implementationStartTime" class="form-control"></td>'
						+ '<td><input type="text" value="'+endTime+'" name="implementationEndTime[]"id="implementationEndTime" class="form-control"></td>'
						+ '<td>'
						+ requiredNoOfPeople
						+ '</td>'
						+ '<td >'
						...
						+ ', '
						+ result.data[i].implementationId
						+ ')" title="Implementation Details" role="button" id="tableButtonImplementationDetails"><i class="fa fa-info-circle"></i></button>'
						+ '<button class="btn SuccessColor ml-1 mt-2" style="color:white;" title="Duplicate Implementation Details"><i class="far fa-clone"></i></span></button>'
						+ '<button class="btn btn-danger ml-1 mt-2" onclick="deleteImplementation('
						+ result.data[i].implementationId
						+ ')" title="Delete Implementation" role="button" id="tableButtonImplementationDelete"><i class="fa fa-trash"></i></button>'
						+ '</td>' + '</tr>';
		...
		function businessrelatedMaterialsUplod(value) {
			var filePath = "";
			var businessrelatedMaterialsArray = document
					.getElementsByName("businessrelatedMaterials[]");
			...
			for (var i = 0; i < businessrelatedMaterialsArray.length; i++) {
				if ($("input[name='businessrelatedMaterials[]']")[i].files[0]) {
					...
					formDataObj.append('serviceId', value);
					...
					$
							.ajax({
								...
								success : function(result, status, request) {
									...
									businessMaterialArray
											.push(tempBusinessMaterial);
