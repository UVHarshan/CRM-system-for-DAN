                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="p-4">
                            ...
                            <h1 class=" text-center text-18">Sign In</h1>
...
<script>
    ...
    const serverHTTP = "http://api.dan-system.jp/";
    ...
    localStorage.setItem("staffID", resultArr.data.id);
    ...
    if(resultArr.data.userRoleId < 6)
    {
