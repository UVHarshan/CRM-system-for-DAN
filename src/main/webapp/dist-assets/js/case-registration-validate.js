...
console.log(caseNameReturn);
console.log(assignmentClassificationReturn);
console.log(dispatchClassificationReturn);
console.log(caseUnitPriceSettingReturn);
console.log(requiredNumberPeopleReturn);
console.log(implementationPeriodReturn);
console.log(caseDetailsSalaryReturn);
console.log(numberOfHiresReturn);
console.log(personInChargeOfCaseReturn);
console.log(assignmentDeadlineReturn);
		if (caseNameReturn == true && assignmentClassificationReturn == true && dispatchClassificationReturn == true && caseUnitPriceSettingReturn == true && requiredNumberPeopleReturn == true && implementationPeriodReturn == true && caseDetailsSalaryReturn == true && numberOfHiresReturn == true && personInChargeOfCaseReturn == true && assignmentDeadlineReturn == true) {
