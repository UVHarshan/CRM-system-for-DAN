...
CaseView = [
     ...
     ["spanScheduledDepartureTime2", "Scheduled departure time"],
	 ["spanArrivalConfirmation", "Arrival Confirmation"],
	 ["spanReportArrival", "Report arrival"],
	 ["PArrivalConfirmationHelpText", "Please be sure to report your arrival by tapping the button when you arrive."],
	 ["spanReportClosing", "Enter the closing report"],
	 ["spanClosingConfirmation", "Closing confirmation"],
	 ["PClosingConfirmationHelpText", "Be sure to tap the button at the end of work and enter the end of work report. (Please follow the company's instructions for the submission deadline.)"],
	 ["spanOutputWorkingConditionNotification", "Output of working condition notification and working condition statement"],
	 ["ButtonSpanOutputWorkingConditionNotification", "Output of working condition notification and working condition statement"],
	 ["POutputWorkingConditionNotificationHelpText", "You can download the working condition notice and working condition statement in excel format."],
	 ["spanConfirmationWorkingConditionNotification", "Confirmation of working condition notification and working condition statement"],
	 ["ButtonSpanConfirmationWorkingConditionNotification", " Confirm working condition notification and working condition statement"],
	 ["PConfirmationWorkingConditionNotificationHelpText", "Please tap the button when confirming the working condition notification and working condition statement."],
...
pageNameData =[
	["spanWorkLoaction[]","Work Loaction :"],
	["spanWorkAddress[]","Work Address : "],
	["spanDepartureTime[]","Departure Time : "]
	];