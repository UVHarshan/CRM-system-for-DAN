...
<title id="pageTitleMonthlyIncomeTaxesDetails">Monthly Income Taxes
	Details</title>
<link
...
<body class="text-left">
									...
									<div class="col-md-6 ">
										<h1>
											<i class="fa fa-calculator text-30" role="generic"></i><span
												id="pageSpanHeadingIncomeMonthlyDetails"> Monthly Income Tax Details </span>
										</h1>
										<p class="pb-0 mb-0"
											id="pageSpanSubHeadingIncomeTaxMonthlyDetails">You can
											check the details of the monthly  income tax amount.</p>
									</div>
									<div class="col-md-6">
	...
	<script src="./dist-assets/js/monthly-income-taxes-details-validate.js"></script>
   ...
   if(result.data!=null){
	document.getElementById("incomeTaxID").value = result.data.id;
   	...
   	document.getElementById("taxRate").value = result.data.typeA_Rate;
