...
<body class="text-left">
									...
									<div class="col-md-4  ">
										...
										<div class="row pt-0 ">
											<div class="col-sm-12 pr-4  TopButDiv">
                                                ...
                                                <button class="dropdown-item" id="caseDelete" href="#"><span id="buttonValueSpanCaseImplementationDelete">Delete Case Implementation</span></button>
                                                </div>
                                               </div>
	...
	<script>
				...
				.ready(
						function() {
							...
							$.ajax({
								...
								url : serverHTTP + 'Case/ViewImplementationDetail',
								method : 'POST',
								contentType : 'application/json',
								data : dataNode,
								dataType : 'json',
							...
							$.ajax({
								...
								url : serverHTTP + 'Case/ViewWorkLocationDetail',
								method : 'POST',
								contentType : 'application/json',
								data : dataPass,
								dataType : 'json',
							...
							$.ajax({
								...
								url : serverHTTP + 'Case/ViewWorkingCondition',
								method : 'POST',
								contentType : 'application/json',
								data : dataPass,
								dataType : 'json',
							...
							$.ajax({
								...
								url : serverHTTP + 'Case/ViewAssignmentDetail',
								method : 'POST',
								contentType : 'application/json',
								data : dataNode,
								dataType : 'json',
		...
		function getImplementationInfo(result){
			...
			$('#workingDays1').prop('checked',
					result.data.workingDay1);
			$('#workingDays2').prop('checked',
					result.data.workingDay2);
			$('#workingDays3').prop('checked',
					result.data.workingDay3);
			$('#workingDays4').prop('checked',
					result.data.workingDay4);
			$('#workingDays5').prop('checked',
					result.data.workingDay5);
			$('#workingDays6').prop('checked',
					result.data.workingDay6);
			$('#workingDays7').prop('checked',
					result.data.workingDay7);
			
			$('#holiday1').prop('checked',
					result.data.holiday1);
			$('#holiday2').prop('checked',
					result.data.holiday2);
			$('#holiday3').prop('checked',
					result.data.holiday3);
			$('#holiday4').prop('checked',
					result.data.holiday4);
			$('#holiday5').prop('checked',
					result.data.holiday5);
			$('#holiday6').prop('checked',
					result.data.holiday6);
			$('#holiday7').prop('checked',
					result.data.holiday7);
