...
<body class="text-left">
	...
	<div id="sideBarDiv"
        ...
        loadSelectedLanguage(pageLanguage,"shift-schedule");
       </script>
      ...
      if(result.data1 != null)
      {
    	  if(result.data1.shiftScheduleDateDtoList != null)
    	  {
    		  ...
    		  if(result.data1.shiftScheduleDateDtoList.length != 0)
    		{
    		  ...
    		  document.getElementById("btnRegisterShiftSchedule").disabled = false; // Uvindu - 19/11  //w11-25
    ...
    function registerShiftSchedule()
    {
       ...
       // var qualificationTypeArray = document.getElementsByName("staffQualification[]");
        ...
        let dateW = new Date();
        let currentYearW  = dateW.getFullYear();
        let currentMonthW = dateW.getMonth()+1;
        let currentDateW = dateW.getDate();
        let todayW =  currentYearW+"-"+currentMonthW+"-"+currentDateW;
    	...
    	dataNode['uuid'] = UUID ;
    	dataNode['submissionDate'] = todayW;
