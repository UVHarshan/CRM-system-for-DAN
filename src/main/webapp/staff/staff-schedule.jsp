	...
	<div id="sideBarDiv"
							...
							<div class="card-body p-0">
								...
								<div class="row  ml-2">
									<div class="col-md-12  pt-0 pr-4">
										<span id="" class="text-20"><span id="spanUIThisMonth"> </span></span> &nbsp; <span id="spanAllChanged" class="text-15">All
	  ...
	  dataNodeLoad["targetYear"] = year ; 
        ...
        function setLanguageWithTables(selectedLanguage) {
			loadSelectedLanguage(selectedLanguage,"shift-schedule");
      ...
      if(result.data1 != null)
      {
    	  if(result.data1.shiftScheduleDateDtoList != null)
    	  {
    		...
    		if(result.data1.shiftScheduleDateDtoList.length != 0)
    		{
    		  ...
    		  document.getElementById("btnRegisterShiftSchedule").disabled = true; // Uvindu - 19/11 - false
