...
<title id="pageTitleAgencyDetails">Agency Details</title>
<link
...
<body class="text-left">
									...
									<div class="col-md-8 ">
										<h1>
											<i class="fa fa-users text-30" role="generic"></i><span
												id="pageSpanHeadingAgencyDetails"> Agency Details</span>
										</h1>

										<p class="pb-0 mb-0" id="pageSpanSubHeadingAgencyDetails">You can view and update an agency details</p>
									</div>
									<div class="col-md-4">
									<div class="row pt-0 ">
												...
												<div class="card-header pt-2 pb-2" id="headingOne">
													<h5 class="mb-0">
														<button class="btn btn-link2 collapsed SDAccordion"
															...
															aria-expanded="false" aria-controls="agencyInformation">
															<div class="row">
																<div class="col-10" style="text-align: left;"
																	id="accordionDivAgencyInformation">Agency Information</div>
														...
														<div class="row pb-4">
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanAgencyName"> Agency Name </span><span
																		class="RequiredStar">*</span>
																</div>
																<div>
																	<input type="text" id="agencyName" class="form-control" maxlength="255">
																</div>
																<div id="errorAgencyName" style="color: red;"></div>
															</div>
															
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanAgencyNameKatakana">Agency Name Katakana </span>
																</div>
																<div>
																	<input type="text" id="agencyNameKatakana" class="form-control" maxlength="255"> 
																</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageLabelContactNumber">Contact Number</span>
															...
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanFaxNumber">Fax </span>
																</div>
																<div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="text" id="AgencyCode" class="form-control" readonly> 
																</div>
																<div id="errorAgency" style="color: red;"></div>
															</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanAgencyContact"> Agency Contact </span>
																	
																</div>
																<div>
																	<input type="text" id="agencyContact" class="form-control"> 
																</div>
																<div id="errorAgencyContact" style="color: red;"></div>
															</div>
															
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanAgencyRepresentativeNameKatakana"> Agency Representative Name </span>
																	
																</div>
																<div>
																	<input type="text" id="agencyRepresentativeName" class="form-control"> 
																</div>
																<div id="errorAgencyRepresentativeName" style="color: red;"></div>
															</div>
															
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanAgencyContactKana">Agency Representative Name Katakana</span>
																	
																</div>
																<div>
																	<input type="text" id="agencyRepNameKatakana" class="form-control" >
																</div>
																<div id="errorAgencyRepNameKatakana" style="color: red;"></div>
															</div>
															...
															<div
																...
																<button
																	...
																	id="buttonUpdateAgencyInformation">Update Agency Information</button>
															</div>
														</div>
	...
	<script src="./dist-assets/js/agency-details-validate.js"></script>
	
	<script>
	    const serverHTTP = "<%=serverHTTP%>";
        const  GUID = localStorage.getItem("GUID");
        const  searchUuid = sessionStorage.getItem('agencyId');  /////////
		...
		$(document)
				.ready(
						function() {
							...
							let dataRequrest = '{"id" : 0, "authority": '+role+ '}';
							...
							$.ajax({
							 ...
							 let dataSet = '{"uuid" : "'+searchUuid+'"}';
						        ...
						        $.ajax({
						            ...
						            url: serverHTTP +'Agency/SearchByUUIDAgency',
						            method: 'POST',
						            contentType: 'application/json',
						            data: dataSet,
						            dataType: 'json',
		...
		function  getAgencyInfo(result)  /// Should change thiss
		{
			//document.getElementById("companyId").value = result.data.id;
		    document.getElementById("agencyName").value = result.data.agencyName;
		    document.getElementById("agencyNameKatakana").value = result.data.agencyNameKatakana;
		    ...
		    document.getElementById("companyContactNumber").value = result.data.telAgency;
		    ...
		    document.getElementById("AgencyCode").value = result.data.agencyCode;
		    ...
		    document.getElementById("agencyRepresentativeName").value = result.data.agencyRepresentativeName;
		    document.getElementById("agencyRepNameKatakana").value = result.data.agencyRepresentativeNameKatakana;
		    document.getElementById("agencyContact").value = result.data.agencyContact;
		...
		function updateAgencyInfo() 
		{
			...
			var agencyNameKatakana = document.getElementById("agencyNameKatakana").value;
			...
			var agencyRepresentativeName = document.getElementById("agencyRepresentativeName").value;
			var agencyRepNameKatakana = document.getElementById("agencyRepNameKatakana").value ;
			...
			let dataPassNode = {};
			dataPassNode['uuid'] = null;
			dataPassNode['agencyName'] = agencyName.trim();
			dataPassNode['agencyNameKatakana'] = agencyNameKatakana.trim();
			...
			dataPassNode['telAgency'] = companyContactNumber.trim();
			dataPassNode['fax'] = companyFaxNumber.trim();
			dataPassNode['email'] = companyEmailAddress.trim();
			dataPassNode['agencyCode'] = AgencyCode.trim();
			...
			//dataPassNode['country'] = companyAddress.trim();
			dataPassNode['organizationName'] = companyOrganizationName.trim();
			dataPassNode['billingDeadLine'] = companyBillingDeadline;
			dataPassNode['agencyRepresentativeName'] = agencyRepresentativeName.trim();
			dataPassNode['agencyRepresentativeNameKatakana'] = agencyRepNameKatakana.trim();
			dataPassNode['agencyContact'] = agencyContact.trim();
			dataPassNode['accountManager'] = companyManager.trim();	
			dataPassNode['belongings'] = companyManager.trim();	
			...
			$.ajax({
				...
				url : serverHTTP + 'Agency/PostAgency',
				method : 'POST',
				contentType : 'application/json',
				...
				success : function(result, status, request) {
					if (result.status == 200) {
						document.getElementById("buttonRegisterAgencyInformation").disabled = true;
