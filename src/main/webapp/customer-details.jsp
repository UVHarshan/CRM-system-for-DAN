...
<body class="text-left">
										   ...
										   <div class="row pt-0  pr-2">
                                            <div class="col-sm-12 pr-4 TopButDiv">
                                             <div class="btn-group">
                                                ...
                                                <a class="dropdown-item" onclick="createCase()" ><span id="buttonValueSpanCustomerProposalCreation">Proposal creation</span></a>
                                                <a class="dropdown-item" onclick="createInvoice()"><span id="buttonValueSpanCustomerInvoiceCreation">Invoice Creation</span></a>
	...
	<script>
		...
		{
			let customerIds = document.getElementById("companyId").value;
			let url = "quotation-registration.jsp";
			let form = $('<form action="' + url + '" method="post">' +
			'<input type="hidden" name="customerId" value="'+customerIds+'" />' +
			'</form>');
			$('body').append(form);
			form.submit();
		}
		...
		function createCase()
		{
			...
			localStorage.setItem("createCaseCompanyId", companyId);	
