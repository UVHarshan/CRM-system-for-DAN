...
<title id="pageTitleStaffDetails">Staff Details</title>
<link
...
<body class="text-left">
							...
							<div class="card-body p-0">
								<div class="row pt-4 mt-2 ml-2">
									...
									<div class="col-md-4 ">
										<h1>
											<i class="fa fa-users text-30" role="generic"></i><span
												id="pageSpanHeadingStaffDetails"> Staff Details</span>
										</h1>
									...
									<div class="col-md-8  ">
											...
											<div class="col-sm-12 pr-4 TopButDiv">
												<div class="btn-group">
													<button
														...
														aria-expanded="false">
														<span id="buttonSpanStaffDetailsOption">Option</span>
													</button>
													<div class="dropdown-menu" x-placement="bottom-start">
														<button class="dropdown-item" id="userRegister" href="#">
															<span id="buttonValueSpanStaffDetailsRegister">Register
																Staff</span>
														</button>

														<button class="dropdown-item" id="userDelete" href="#">
															<span id="buttonValueSpanStaffDetailsDelete">Delete
																Staff</span>
														</button>
													</div>
												</div>
										...
										<div class="row pt-0 ">
											<div class="col-sm-12 pr-4  TopButDiv">
												<button onclick="viewShiftSchedule()"
													class="DefaultButton btn btn-info TopButtonMinWidth mr-2"
													role='button'>
													<span id="buttonSpanScheduledShifts">Scheduled
														Shifts</span>
												</button>
												<button
													class="DefaultButton btn btn-info TopButtonMinWidth mr-2"
													role='button' onclick="viewAttendence()">
													<span id="buttonSpanAssinmentList">Assinment List</span>
												</button>
												...
												<div id="staffInformation" class="collapse show"
													...
													<div class="card-body SDAccordionCardBody">
                                                        ...
                                                        <button class="btn SuccessColor ml-1">Adress Search</button>
																	...
																	<span id="pageSpanHelpZipCode"> Please enter
																		without hyphens</span>
																</div>
															</div>
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="text" id="staffFax" class="form-control" maxlength="11">
															...
															<span id="agencyDetailsDiv"></span>
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3" id="divAgencyName" style="display: none;">
																<div class="DetailsTitleText">
																	<span id="pageSpanAgencyName">Agency Name</span>
																</div>
																<div>
																	<input type="text" id="staffAgencyName" value="" class="form-control" readonly>
																</div>
																<div id="errorFax" class="RequiredStar"></div>
															 </div>
															 
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3" id="divAgencyCode" style="display: none;">
															<div class="DetailsTitleText">
															<span id="pageSpanAgencyCode">Agency Code</span>
															</div>
															<div>
																<input type="text" id="staffAgencyCode" value="" class="form-control" readonly>
															</div>
															<div id="errorFax" class="RequiredStar"></div>
														    </div>
															...
															<div class="col-sm-12 col-md-12 col-lg-12  pt-4 pl-3 pr-3">
																<div class="DetailsTitleText">
                                                              ...
                                                              <tr>
																...
																<input type="hidden" id="staffUUIDHidden"/>
																<div class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-0 mt-3 ContentAlignRC">
																	<button  class="btn DefaultButton btn-info TopButtonMinWidth"
																	id="buttonEditStaffInformation">Update Staff Information</button>
																</div>
															</div>
														</div>
													</div>
													...
													<div class="card-body SDAccordionCardBody">
														<div class="row pb-4">
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="text" id="staffTimeRequiredNearestStation"
																		class="form-control">
																</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="text" id="staffRoundTripBusFare"
																		class="form-control"> <span
															...
															<div
																...
																<button 
																	...
																	id="buttonEditTransportationInformation">Update
														...
														<div class="row pt-3 pb-3">
															...
															<div class="col-sm-12 col-md-12 col-lg-12 mt-3">
																<div class="table-responsive">
																	...
																	<div
																		class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-0 mt-3 ContentAlignRC">
																		<button class="btn SuccessColor"
																			onclick="addLicenseRow()" id="addLicens">Add
																			Row </button>
																	</div>
																</div>
																<br>
																...
																<div
																	...
																	<button onclick="checkCredential()"
																		class="btn btn-info"
																		id="buttonEditCredentialInformation">Update
																		Credential Information</button>
																</div>
															</div>
														</div>
													</div>
											...
											<div class="card SDAccordionCard mb-2">
												...
												<div id="resumeInformation" class="collapse"
													...
													<div class="card-body SDAccordionCardBody">
																		...
																		<tbody id="educationalTbodyId">
																			<tr id="educationalTrId">
																				...
																				<td style="width: 15%;" class="p-1"><input
																					...
																					class="form-control"></td>
																				<td><input name="staffInstitute[]" type="text"
																					class="form-control"></td>
																				<td><input type="text"
														...
														<div
															class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-0 ContentAlignRC">
															<button onclick="checkResume()" class="btn btn-info"
																id="buttonEditStaffResume">Update Staff Resume</button>
														</div>
													</div>
												</div>
											</div>
													...
													<div class="card-body SDAccordionCardBody">
														...
														<div class="row pb-3">
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="text" id="staffSalaryUnitPrice"
																		class="form-control"> <span
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<input type="text" id="staffHourlyWageUnitPrice"
																	class="form-control"> <span
														...
														<div class="row pb-4" id="transferMainDiv"
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="text" id="staffBankCode"
																		class="form-control">
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="text" id="staffBranchCode"
																		class="form-control">
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="text" id="staffAccountNumber"
																		class="form-control">
																</div>
														...
														<div
															class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-0 ContentAlignRC">
															<button  class="btn btn-info"
																id="buttonEditPayrollInformation">Update
													...
													<div class="card-body SDAccordionCardBody">
														...
														<div class="row pb-3">
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="text" id="staffSkillNameInit"
																		class="form-control">
																</div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="text" id="staffSkillCurrentAddress"
																		class="form-control">
																</div>
															...
															<div class="col-sm-12 col-md-12 col-lg-12 pt-2 pl-3 pr-3">
																<div class="table-responsive">
																	...
																	<div
																		class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-0 ContentAlignRC">
																		<button class="btn SuccessColor"
																			onclick="addSkillSheetRow()" id="addSkillSheetRow">Add
																			Row</button>
																	</div>
																</div>
															</div>
															<div
																...
																<div>
																	<textarea class="form-control" id="staffSkillRemark"
																		></textarea>
																</div>
															</div>
															...
															<div
																...
																<button  class="btn btn-info"
																	id="buttonEditSkillSheet">Update Skill Sheet</button>
															</div>
														...
														<div class="row pb-4">
															...
															<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																<div class="DetailsTitleText" id="pageSpanMyNumber">My
																	Number</div>
																<div>
																	<input type="text" id="staffMyNumber"
																		class="form-control">
																</div>
															...
															<div
																...
																<div>
																	<input type="text" id="staffNumberDependents"
																		class="form-control "> <span
															...
															<div
																	...
																	<table
																		...
																		<tbody id="tbodyIdDependent">
																			<tr id="dependentTrId">
																				...
																				<td>
																					<button class="btn SuccessColor mr-1 mb-1"
																						style="color: white;"
																...
																<div
																	class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-0 ContentAlignRC">
																	<button 
																		class="btn btn-info" id="buttonEditSocialInformation">Update
													...
													<div class="card-body SDAccordionCardBody">
														<div class="row pb-4">
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																...
																<div>
																	<input type="date" id="staffDateofleavingthecompany"
																		class="form-control">
																</div>
															</div>
														...
														<div
															class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-0 ContentAlignRC">
															<button onclick="checkOther()" class="btn btn-info"
																id="buttonEditOtherInformation">Update Other
																Information</button>
														</div>
	...
	<script src="./dist-assets/js/staff-edit-validate.js"></script>
...
/*                        if (cropper) {
        ...
        function viewShiftSchedule()
        {
        	let staffUserID = document.getElementById("staffidHidden").value;
...
{
	if(result.data.agencyCode != "")
	{
	  let agencyCode = result.data.agencyCode !=null ? result.data.agencyCode :"";
	  let agencyName = result.data.agencyName !=null ? result.data.agencyName :"";
	  document.getElementById("divAgencyName").style.display = "" ;
	  document.getElementById("staffAgencyName").value = agencyName ;
	  document.getElementById("divAgencyCode").style.display = "" ;
	  document.getElementById("staffAgencyCode").value = agencyCode;
		  
	  
	}
	
	document.getElementById("staffidHidden").value = result.data.id;
	document.getElementById("staffUUIDHidden").value = result.data.uuid;
	 ...
	 if(result.data.length>0)
	 {
	  ...
	  for(i=0;i<result.data.length;i++){
	    ...
	    let newRow =' <tr id="licenceTrId">'+
	                     '<input type="hidden" value="'+result.data[i].id+'" name="licenseQualificationID[]">'+
                         '<td style="width: 15%;" class="p-1">'+
                          '<input type="month" value="'+result.data[i].dateFrom+'" name="staffLicenseQualificationDateFrom[]" class="form-control">'+
                         '</td>'+
                         '<td style="width: 15%;"class="p-1">'+
                          '<input type="month" value="'+result.data[i].dateTo+'" name="staffLicenseQualificationDateTo[]" class="form-control">'+
     				     '</td>'+
     				 	 '<td class="p-1"><input type="text" name="staffLicenceQualification[]" value="'+licenceQualification+'" class="form-control"></td>'+
     					 '<td class="p-1"><input type="text" name="staffLicenceNumber[]" value="'+licenceNumber+'" class="form-control"></td>'+
     					 '<td class="p-1"><input type="text" name="staffLicenceOperatingItem[]" value="'+licenceOperatingItem+'" class="form-control"></td>'+
     					'<td>'+
								'<button class="btn btn-danger mr-1 mb-1" onclick="removeLicenceRow(this)"><i class="fa fa-trash"></i></button>'+
								'<button class="btn btn-danger mb-1" onclick="clearRow(this)"  margin-left: 0.1rem;"><i class="fa fa-eraser"></i></button>'+
							'</td>'+
  					 '</tr>';
	 ...
	 if(result.data1.length>0)
	 {
	  ...
	  for(i=0;i<result.data1.length;i++){
	    ...
	    let newRow = '<tr id="educationalTrId">'+
	                    '<input type="hidden" value="'+result.data1[i].id+'" name="staffEducationalID[]">'+
                        '<td style="width: 15%;" class="p-1">'+
        					'<input type="month" value="'+result.data1[i].dateFrom+'"  name="staffEducationalBackgroundDateFrom[]" class="form-control">'+
     					'</td>'+
      					'<td style="width: 15%;"class="p-1">'+
        					'<input type="month" value="'+result.data1[i].dateTo+'"  name="staffEducationalBackgroundDateTo[]" class="form-control">'+
      					'</td>'+
      					'<td class="p-1"><input type="text" name="staffInstitute[]" value="'+institute+'" class="form-control"></td>'+
      					'<td class="p-1"><input type="text" name="staffQualification[]" value="'+qualificationType1+'" class="form-control"></td>'+
      					'<td >'+
					    '<button class="btn btn-danger mr-1 mb-1" onclick="removeEducationalRow(this)"><i class="fa fa-trash"></i></button>'+
					    '<button class="btn btn-danger mb-1" onclick="clearRow(this)"><i class="fa fa-eraser"></i></button>'+
					'</td>'+
      				 '</tr>';
	  ...
	  if(result.data2.length>0)
		 {
		  ...
		  for(i=0;i<result.data2.length;i++){
		    ...
		    let newRow = '<tr id="workTrId">'+
		                    '<input type="hidden" value="'+result.data2[i].id+'" name="staffWorkHistoryCredentialsID[]">'+ 
	                        '<td style="width: 15%;" class="p-1">'+
	        					'<input type="month" value="'+result.data2[i].dateFrom+'"  name="staffWorkHistoryCredentialsDateFrom[]" class="form-control">'+
	     					'</td>'+
	      					'<td style="width: 15%;"class="p-1">'+
	        					'<input type="month" value="'+result.data2[i].dateTo+'" name="staffWorkHistoryCredentialsDateTo[]" class="form-control">'+
	      					'</td>'+
	      					'<td class="p-1"><input type="text" name="staffDesignationCredentials[]" value="'+designation+'" class="form-control"></td>'+
	      					'<td class="p-1"><input type="text" name="staffCompanyNameCredentials[]" value="'+companyName+'" class="form-control"></td>'+
	      					'<td class="p-1"><input type="text" name="staffExperienceTypeCredentials[]" value="'+experienceType+'" class="form-control"></td>'+
	      					'<td >'+
						    '<button class="btn btn-danger mr-1 mb-1" onclick="removeWorkRow(this)"><i class="fa fa-trash"></i></button>'+
						    '<button class="btn btn-danger mb-1" onclick="clearRow(this)"><i class="fa fa-eraser"></i></button>'+
						    '</td>'+
	      				 '</tr>';
	 ...
	 if(result.data2.length>0){ 
 	 ...
 	 for(i=0; i<result.data2.length; i++){
	   ...
	   var newRowSkill= '<tr id="SkillSheetTrId">'+
           '<input type="hidden" value="'+result.data2[i].id+'"  name="staffWorkHistoryID[]" >'+
		   '<td style="width: 15%;" class="p-1"><input type="month" max="08-31-2021" value="'+result.data2[i].dateFrom+'" name="staffWorkHistoryDateFrom[]" id="staffWorkHistoryDateFrom" class="form-control"></td>'+
		   '<td style="width: 15%;" class="p-1"><input type="month" value="'+result.data2[i].dateTo+'" name="staffWorkHistoryDateTo[]" id="staffWorkHistoryDateTo" class="form-control"></td>'+
		   '<td class="p-1"><input type="text" value="'+designation+'" name="staffDesignation[]" id="staffDesignation" class="form-control"></td>'+
		   '<td class="p-1"><input type="text" value="'+companyName+'" name="staffCompanyName[]"  id="staffCompanyName" class="form-control"></td>'+
		   '<td class="p-1"><input type="text" value="'+experienceType+'" name="staffExperienceType[]"id="staffExperienceType" class="form-control"></td>'+
		   '<td >'+
			'<button class="btn btn-danger mr-1 mb-1" onclick="removeSkillSheetRow(this)"><i class="fa fa-trash"></i></button>'+
			'<button class="btn btn-danger mb-1" onclick="clearRow(this)"><i class="fa fa-eraser"></i></button>'+
		   '</td>'+
		   '</tr>';  
	 ...
	 if(result.data2.length>0)
	 {
 	 ...
 	 for(i=0; i<result.data2.length; i++){
 		...
 		var newRowDependent ='<tr id="dependentTrId">'+
             '<td  class="p-1">'+
 		       '<input type="hidden" value="'+result.data2[i].id+'" name="staffDependentsID[]" />'+
               '<input type="text"   value="'+familyName+'" name="staffDependentsName[]" class="form-control"></td>'+
              '<td  class="p-1"><input type="text" value="'+nameKatakana+'" name="staffDependentsNamekatakana[]" class="form-control"></td>'+
              '<td  class="p-1"><input type="date" value="'+result.data2[i].dependentBirthday+'" name="staffDependentsBirthday[]" class="form-control"></td>'+
              '<td  class="p-1">'+
                  '<select id="staffDependentsGender" name="staffDependentsGender[]" class="form-control">'+
             ...
             ' </td>'+
              '<td  class="p-1">'+
                  '<select name="staffDependentsRelationship[]" class="form-control">'+
                 ...
                 ' </td>'+
             ' <td  class="p-1">'+
             ' <select name="staffDependentsClassification[]" class="form-control">'+
                 ' <option value=""></option>'+
                 ...
                 ' </td>'+
             ' <td  class="p-1">'+
             ' <select name="staffDependentsLivingtogether[]" class="form-control">'+
                 ' <option value=""></option>'+
                 ...
                 '</td>'+
             ' <td  class="p-1">'+
             '<select  name="staffDependentsHandicapped[]" class="form-control">'+
                 '<option value=""></option>'+
                 ...
                 '</td>'+
                ' <td >'+
				    '<button class="btn SuccessColor mr-1 mb-1" style="color:white;" onclick="copyDependentRow(this)">'+
						'<span id="btnSpanDuplicate"><i class="far fa-clone"></i></span>'+
					'</button>'+
					' <button class="btn btn-danger mr-1 mb-1" onclick="removeDependentRow(this)"><i class="fa fa-trash"></i></button>'+
				    '<button class="btn btn-danger mb-1" onclick="clearDependentRow(this)"><i class="fa fa-eraser"></i></button>'+
					'</td>'+
              '</tr>';
 ...
 function getOtherInfo(result)
 {
	...
	if(result.data.profilePicturePath != null)
	{
...
function editPayrollInfo()
                     	 ...
                     	 var formDataObj = new FormData();
            				...
            				$.ajax({
            					...
            					success : function(result, status, request) {
            						...
            						console.log(result);
            						editOtherInfoSecond(result.data.imagePath)
	...
	function editOtherInfoSecond(imagePath)
	{
