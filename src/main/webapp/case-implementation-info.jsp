												...
												<div id="customerInformation" class="collapse show"
													...
													<div class="card-body SDAccordionCardBody">
														<div class="row pb-4">
															...
															<div class="col-sm-12 col-md-6 col-lg-6  pt-2 pl-3 pr-3">
																<div class="DetailsTitleText">
																	<span id="pageSpanEmploymentStatus"> Whether it
																		is permanent employment or fixed-term employment or a
																		 dispatched worker subject to
																		the agreement</span>
																</div>
																<div>
															...
															<div class="col-sm-12 col-md-6 col-lg-6 mt-2  pt-4 pl-3 pr-3  mb-0 pb-0" style="vertical-align:bottom;">
...
$(document).ready(function() {
		...
		function showResult(result,request){
			...
			document.getElementById("contractRenewalRelated").value = result.data[0].contract_renewal;
			document.getElementById("conflictPreventionMeasures").value = result.data[0].conflict_prevention;
			document.getElementById("workConditionRemarks").value = result.data[0].remarks;
