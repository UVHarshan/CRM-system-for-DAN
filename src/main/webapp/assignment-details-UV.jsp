														...
														<div class="row pb-4">
															...
															<div id="hideOutSource">
																<div class="row pb-4">
																	...
																	<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																		...
																		<div>
																			<span id="pageSpanBreaketimeSchedule"> If the
																				...
																				Example: If you take a break from 1:00 to 2:00,
																				enter the break time 1:00 and midnight break time
																				1:00. Example: If you take a break from 21:00 to
																				22:00, enter only the break time 1:00.</span>
																		</div>
																	...
																	<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																		<div class="DetailsTitleText">
																			<span id="pageSpanMidnightLaborCosts">
																				Midnight labor costs </span>
																		</div>
																		<div>
																	...
																	<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																		<div class="DetailsTitleText">
																			<span id="pageSpanHolidayWorkingHours">
																				Holiday Working Hours </span>
																		</div>
																		<div>
																	...
																	<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																		<div class="DetailsTitleText">
																			<span id="pageSpanOvertimeBillingFee">
																				Overtime Billing Fee </span>
																		</div>
																		<div>
																	...
																	<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																		...
																		<div id="errorMidnightLaborBilling"
																			style="color: red;"></div>
																	</div>

																	<div class="col-sm-12 col-md-6 col-lg-6 pt-2 pl-3 pr-3">
																		<div class="DetailsTitleText">
																			<span id="pageSpanHolidayLaborBilling">
																				Holiday Labor Billing fee </span>
																		</div>
																		<div>
...
<%-- 	const implementationIDDetails = "<%= request.getParameter("implementationIDDetails")%>" ;
		...
		// Change UI for Assign By Period
		function changeUIforAssignByPeriod(){
			var assignmentClassifi = document.getElementById("AssignmentClassification").value;
			if( assignmentClassifi == "Assign By Period"){
				$("#accordionDailysalaryInfo").hide();				
			}
		}
		...
		function GetAllAssignStaffDetail(result) {
			...
			let dataSet = '{"assignmentId" : "' + result.data[0].assignmentId +  '"}';
			 ...
			 changeUIforAssignByPeriod(); // Change UI for AssignByPeriod
