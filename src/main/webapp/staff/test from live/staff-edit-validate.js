...
function checkStaff() {
	...
	if (staffAddressKatakana.value.trim() == "") {
		...
		staffAddressKatakanaReturn = false;
	} else {
...
function checkTransport() {
	...
	let staffNearestStationReturn = true;
	let staffTimeRequiredNearestStationReturn = true;
	let staffRoundTripBusFareReturn = true;
	...
	if (staffTimeRequiredNearestStation.value.trim() == "") {
...
function checkSkillSheet() {
	...
	if ((firstRowValidator == 0 || firstRowValidator == 2) && SkillSheetStatus == true && staffSkillNameInitReturn == true) {
...
function checkLoginInfo() {
	...
	//alert(staffNewPassword.value.trim().length);
...
function checkOther() {
	...
	if (!/^([^0-9]*)$/.test(staffEmergencyContactNameKatakana.value) || /[~`!@#$%^&()_={}[\]:;,.<>+\/?-]/.test(staffEmergencyContactNameKatakana.value) || staffEmergencyContactNameKatakana.value.trim() == "") {
		setErrorFor(staffEmergencyContactNameKatakana, errorStaffEmergencyContactNameKatakana, "E1038");/////////////
	...
	if (staffEmergencyPrefecture.value == "") {
...
/*	if (staffEmergencyAddress.value == "") {
	...
	if (staffFacePhotoFileReturn == true && staffStaffCodeReturn == true && staffEmergencyPrefectureReturn == true && staffEmergencyAddressReturn == true && staffEmergencyContactPhoneNumberReturn == true && staffCompanyJoiningDateReturn == true && staffValidClassifiReturn == true) {
		editOtherInfo();
	} else {
...
function checkPostalCode() {
	...
	if (/^[0-9]{6}$/g.test(staffEmergencyPostalCode.value)) {
