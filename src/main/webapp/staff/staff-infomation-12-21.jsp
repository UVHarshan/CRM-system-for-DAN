...
<head>
    ...
    <title id="pageTitleStaffInformation">Staff - Staff Information</title>
                        ...
                        <div id="bodyMainCard" class="card mb-4">
                           ...
                           <div class="row pt-4 pr-3  mt-2 ml-2">
									<div class="col-sm-12 TopActionButDiv mr-4  "></div>
                         	          <div class="col-md-4 " >
                                        <h1 > <i class="fa fa-user text-30" role="generic"></i><span id="pageSpanHeadingStaffInformation"> Staff Information</span> </h1>
									...
									<div class="col-md-12  pt-0 pr-4 ">
									  <p id="pageSpanHeadingText1" class="pt-0 pb-0 mt-0 mb-0">You can check the registration information and change the password.</p>
                                      <p id="pageSpanHeadingText2" class="pt-0 pb-0 mt-0 mb-0">If there is any change in your registration information, Please contact your dispatching company by phone.</p>
							       </div>
							  </div>
                             <div class="row  ml-2 mr-2">
                             <div class="col-md-12  pt-0 pr-4">
                             <div class="table-responsive pt-2">
								<table class="display table table-striped table-bordered hover" id="StaffInformationTable" style="width: 100%">
								    <tbody id="tbodyIdStaffInformationBody">
								     <tr id="StaffInformationTableTr" >
									 ...
									 <tr>
										  <td   class="p-1" >
										  <span id="spanNameKatakana">Name Katakana</span> 
										  </td>
										  <td >
									 ...
									 <tr>
										  <td   class="p-1" >
										  <span id="spanPostalCode">Postal Code</span> 
										  </td>
										  <td >
									 ...
									 <tr>
										  <td   class="p-1" >
										  <span id="spanPrefecture">Prefecture</span> 
										  </td>
										  <td >
									  ...
									  <tr>
										  <td   class="p-1" >
										  <span id="spanAddress">Address</span> 
										  </td>
										  <td >
