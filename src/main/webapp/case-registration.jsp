...
<body class="text-left">
	...
	<script>
		...
		let caseId = "";
		const createCaseCompanyId = localStorage.getItem('createCaseCompanyId');
		...
		if(quotationId!= null){
			...
			}else if(createCaseCompanyId != null){
				let dataSet = '{"customerId": ' + createCaseCompanyId + '}';
				 $.ajax({
					beforeSend : function(request) {
					 request.setRequestHeader("GUID", GUID);
					},
					url : serverHTTP + 'Case/GetCaseInfoByCustomer',
					method : 'POST',
					contentType : 'application/json',
					data : dataSet,
					dataType : 'json',
		...
		$.ajax({
			...
			success : function(result, status, request) {
				if (result.status == 202) {
					...
					LoadImplementationInfo(result.data.id);
